...
| Exposes | ext_voltage, comp_state, tgt_voltage, voltage_type, identify, battery, voltage, battery_low, pulse_frequency, pulse_count |
...
The possible values are: `AC`, `DC`, `DC_COUNTER`.
