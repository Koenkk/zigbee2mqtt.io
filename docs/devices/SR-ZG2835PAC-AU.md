---
title: "Sunricher SR-ZG2835PAC-AU control via MQTT"
description: "Integrate your Sunricher SR-ZG2835PAC-AU via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness), effect, power_on_behavior, external_switch_type, power, voltage, current, energy, linkquality |
