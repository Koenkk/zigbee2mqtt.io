---
title: "Moes ZB-TDC6-RCW-E14 control via MQTT"
description: "Integrate your Moes ZB-TDC6-RCW-E14 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|     |     |
|-----|-----|
| Model | ZB-TDC6-RCW-E14  |
| Vendor  | [Moes](/supported-devices/#v=Moes)  |
| Description | RGB+CCT 5W E14 LED bulb |
| Exposes | light (state, brightness, color_temp, color_xy), effect, do_not_disturb, color_power_on_behavior, linkquality |
| Picture | ![Moes ZB-TDC6-RCW-E14](https://www.zigbee2mqtt.io/images/devices/ZB-TDC6-RCW-E14.png) |
