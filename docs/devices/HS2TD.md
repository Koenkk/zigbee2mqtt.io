---
title: "Heiman HS2TD control via MQTT"
description: "Integrate your Heiman HS2TD via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | battery, identify, temperature, humidity, contact, battery_low, alarm_indicator, temperature_offset, humidity_offset, dew_point, vpd, thi, heat_index, reported_packages, rejoin_count, reboot_count |
| Picture | ![Heiman HS2TD](https://www.zigbee2mqtt.io/images/devices/HS2TD.png) |
