---
title: "Manhot MH03-3Z-OLED control via MQTT"
description: "Integrate your Manhot MH03-3Z-OLED via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), countdown_1, countdown_2, countdown_3, child_lock, backlight_switch, backlight_lightness, displayoff_delay, relay_status, light_mode, on_color, off_color, sw1_name, sw2_name, sw3_name, press_on_fun, press_off_fun |
| Picture | ![Manhot MH03-3Z-OLED](https://www.zigbee2mqtt.io/images/devices/MH03-3Z-OLED.png) |
...
The possible values are: `disable`, `press_switch_1`, `press_switch_2`, `press_switch_3`.
