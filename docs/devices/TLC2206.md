...
| Exposes | liquid_state, liquid_level_percent, liquid_depth, min_set, max_set, liquid_depth_max, installation_height |
...
The minimal value is `0.1` and the maximum value is `3`.
The unit of this value is `m`.
