---
title: "Aqara HCXDD12LM control via MQTT"
description: "Integrate your Aqara HCXDD12LM via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_temp), power_outage_count, device_temperature, power_outage_memory, light (state, brightness, color_temp, color_xy, color_hs), dimming_range_minimum, dimming_range_maximum, off_on_duration, on_off_duration |
