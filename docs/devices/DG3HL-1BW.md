---
title: "Leviton DG3HL-1BW control via MQTT"
description: "Integrate your Leviton DG3HL-1BW via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, level_config), ballast_minimum_level, ballast_maximum_level, ballast_power_on_level, identify |
...
Level applied after mains power returns; 255 restores the previous level.
