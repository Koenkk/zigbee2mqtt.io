---
title: "Aqara ZNQBCZ11LM control via MQTT"
description: "Integrate your Aqara ZNQBCZ11LM via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | button_switch_mode, switch (state), device_temperature, power_outage_count, power_on_behavior, led_disabled_night, power, energy, voltage, current, overload_protection, button_lock |
| Picture | ![Aqara ZNQBCZ11LM](https://www.zigbee2mqtt.io/images/devices/ZNQBCZ11LM.png) |
