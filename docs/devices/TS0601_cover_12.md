---
title: "Tuya TS0601_cover_12 control via MQTT"
description: "Integrate your Tuya TS0601_cover_12 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | cover (state, position), motor_direction, motor_state, total_time, situation_set, fault, battery |
| Picture | ![Tuya TS0601_cover_12](https://www.zigbee2mqtt.io/images/devices/TS0601_cover_12.png) |
...
### Situation set (enum)
Set fully open or fully close position.
