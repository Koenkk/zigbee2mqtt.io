...
| Exposes | battery, climate (system_mode, running_mode, occupied_heating_setpoint, local_temperature, pi_heating_demand, schedule), vacation_mode, linkquality |
...
### Climate 
This climate device supports the following features: `system_mode`, `running_mode`, `occupied_heating_setpoint`, `local_temperature`, `pi_heating_demand`, `schedule`.
