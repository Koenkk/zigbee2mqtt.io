...
* `time_close`: Set the full closing time of the roller shutter (e.g. set it to 20) (value is in s)
* `time_open`: Set the full opening time of the roller shutter (e.g. set it to 21) (value is in s)
