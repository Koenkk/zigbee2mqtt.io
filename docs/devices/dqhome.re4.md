---
title: "DQHOME dqhome.re4 control via MQTT"
description: "Integrate your DQHOME dqhome.re4 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | dqhome.re4  |
| Vendor  | [DQHOME](/supported-devices/#v=DQHOME)  |
| Description | DQSmart Switch 4 Gang |
| Exposes | switch (state) |
| Picture | ![DQHOME dqhome.re4](https://www.zigbee2mqtt.io/images/devices/dqhome.re4.png) |
