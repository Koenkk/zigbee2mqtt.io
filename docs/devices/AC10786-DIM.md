...
description: "Integrate your OSRAM AC10786-DIM via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![OSRAM AC10786-DIM](https://www.zigbee2mqtt.io/images/devices/AC10786-DIM.png) |
...
1. Turn ON the bulb for 5 seconds.
2. Turn OFF the bulb for 5 seconds.
3. Repeat the step above four more times for a total of five OFF/ON cycles.
4. After the fifth cycle, turn the light ON and wait for 10 seconds.
5. The bulb will then blink 3 times to indicate it has been reset.
6. Repeat the above steps if the light doesn’t blink.
