---
title: "Hiking DDS238-2 control via MQTT"
description: "Integrate your Hiking DDS238-2 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | DDS238-2  |
| Vendor  | [Hiking](/supported-devices/#v=Hiking)  |
| Description | Single phase DIN-rail energy meter with switch function |
| Exposes | switch (state), faults, ac_frequency, energy, power, power_factor, voltage, current, produced_energy, power_reactive, energy_reactive, total_energy |
| Picture | ![Hiking DDS238-2](https://www.zigbee2mqtt.io/images/devices/DDS238-2.png) |
