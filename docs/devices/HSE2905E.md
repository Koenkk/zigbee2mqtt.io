...
| Exposes | power, energy, produced_energy, voltage, current, power_phase_b, power_phase_c, voltage_phase_b, voltage_phase_c, current_phase_b, current_phase_c, temperature, linkquality |
