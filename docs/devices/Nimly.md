...
| Exposes | lock (state, lock_state), battery, sound_volume, voltage, last_unlock_source, last_unlock_user, last_lock_source, last_lock_user, last_used_pin_code, auto_relock, auto_relock_time, max_pin_users, min_pin_length, max_pin_length, pin_code |
