---
title: "Lonsonho QS-Zigbee-D02-TRIAC-LN_1 control via MQTT"
description: "Integrate your Lonsonho QS-Zigbee-D02-TRIAC-LN_1 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|     |     |
|-----|-----|
| Model | QS-Zigbee-D02-TRIAC-LN_1  |
| Vendor  | [Lonsonho](/supported-devices/#v=Lonsonho)  |
| Description | 1 channel dimmer |
| Exposes | light (state, brightness, min_brightness, max_brightness), light_type, power_on_behavior, switch_type |
| Picture | ![Lonsonho QS-Zigbee-D02-TRIAC-LN_1](https://www.zigbee2mqtt.io/images/devices/QS-Zigbee-D02-TRIAC-LN_1.png) |
