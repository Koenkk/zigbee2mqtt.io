---
title: "Schneider Electric WDE002386 control via MQTT"
description: "Integrate your Schneider Electric WDE002386 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, level_config), ballast_minimum_level, ballast_maximum_level, dimmer_mode, indicator_mode, identify |
| Picture | ![Schneider Electric WDE002386](https://www.zigbee2mqtt.io/images/devices/WDE002386.png) |
...
### Dimmer mode (enum)
Sets dimming mode to autodetect or fixed RL_LED mode (max load is reduced in RL_LED).
...
The possible values are: `auto`, `rl_led`.
