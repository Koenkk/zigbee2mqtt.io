...
| Exposes | switch (state), power_on_behavior, power, voltage, ac_frequency, power_factor, current, energy, reset_total_energy, countdown_time_on_to_off, countdown_time_off_to_on |
