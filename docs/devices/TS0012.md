...
| Picture | ![Tuya TS0012](https://www.zigbee2mqtt.io/images/devices/TS0012.png) |
| White-label | Vrey VR-X712U-0013, TUYATEC GDKES-02TZXD, Earda ESW-2ZAA-EU, Moes ZS-US2-BK-MS |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
## Notes
This device does not act as a Zigbee router.

## Pairing
To enter pairing mode hold button for 10 seconds until all LEDs start flashing.
