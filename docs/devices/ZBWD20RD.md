---
title: "Nedis ZBWD20RD control via MQTT"
description: "Integrate your Nedis ZBWD20RD via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | SmartLife Triac Dimmer |
| Exposes | power_on_behavior, light (state, brightness, min_brightness, max_brightness), switch_type |
