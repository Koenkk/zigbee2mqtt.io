---
title: "IKEA LED2102G3 control via MQTT"
description: "Integrate your IKEA LED2102G3 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA LED2102G3](https://www.zigbee2mqtt.io/images/devices/LED2102G3.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
## Pairing Procedure
To enter pairing mode, turn the bulb on and off six times in succession.  
Once in pairing mode, the bulb will begin to flash, indicating it is ready to be paired.
