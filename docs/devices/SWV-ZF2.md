...
Can be set by publishing to `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_remove_1": {"plan_index": VALUE}}`
- `plan_index` (numeric): The index of the irrigation plan to remove max value is 5

### Irrigation plan remove (composite, 2 endpoint)
Remove irrigation plan.
Can be set by publishing to `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_remove_2": {"plan_index": VALUE}}`
- `plan_index` (numeric): The index of the irrigation plan to remove max value is 5
