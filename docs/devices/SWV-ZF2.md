---
title: "SONOFF SWV-ZF2 control via MQTT"
description: "Integrate your SONOFF SWV-ZF2 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
### Irrigation plan index (numeric, 1 endpoint)
Irrigation plan index.
Value can be found in the published state on the `irrigation_plan_index_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_index_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_index_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `5`.

### Irrigation plan index (numeric, 2 endpoint)
Irrigation plan index.
Value can be found in the published state on the `irrigation_plan_index_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_index_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_index_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `5`.

### Irrigation plan enabled (binary, 1 endpoint)
Enable the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_enabled_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_enabled_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_enabled_1": NEW_VALUE}`.
If value equals `true` irrigation plan enabled is ON, if `false` OFF.

### Irrigation plan enabled (binary, 2 endpoint)
Enable the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_enabled_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_enabled_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_enabled_2": NEW_VALUE}`.
If value equals `true` irrigation plan enabled is ON, if `false` OFF.

### Irrigation plan loop type (enum, 1 endpoint)
Repeat mode for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_loop_type_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_loop_type_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_loop_type_1": NEW_VALUE}`.
The possible values are: `odd_days`, `even_days`, `day_interval`, `weekdays`.

### Irrigation plan loop type (enum, 2 endpoint)
Repeat mode for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_loop_type_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_loop_type_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_loop_type_2": NEW_VALUE}`.
The possible values are: `odd_days`, `even_days`, `day_interval`, `weekdays`.

### Irrigation plan interval days (numeric, 1 endpoint)
Repeat interval in days when loop type is day_interval.
Value can be found in the published state on the `irrigation_plan_interval_days_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_interval_days_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_interval_days_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `30`.

### Irrigation plan interval days (numeric, 2 endpoint)
Repeat interval in days when loop type is day_interval.
Value can be found in the published state on the `irrigation_plan_interval_days_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_interval_days_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_interval_days_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `30`.

### Irrigation plan sunday (binary, 1 endpoint)
Run the selected irrigation plan on sunday.
Value can be found in the published state on the `irrigation_plan_sunday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_sunday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_sunday_1": NEW_VALUE}`.
If value equals `true` irrigation plan sunday is ON, if `false` OFF.

### Irrigation plan sunday (binary, 2 endpoint)
Run the selected irrigation plan on sunday.
Value can be found in the published state on the `irrigation_plan_sunday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_sunday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_sunday_2": NEW_VALUE}`.
If value equals `true` irrigation plan sunday is ON, if `false` OFF.

### Irrigation plan monday (binary, 1 endpoint)
Run the selected irrigation plan on monday.
Value can be found in the published state on the `irrigation_plan_monday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_monday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_monday_1": NEW_VALUE}`.
If value equals `true` irrigation plan monday is ON, if `false` OFF.

### Irrigation plan monday (binary, 2 endpoint)
Run the selected irrigation plan on monday.
Value can be found in the published state on the `irrigation_plan_monday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_monday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_monday_2": NEW_VALUE}`.
If value equals `true` irrigation plan monday is ON, if `false` OFF.

### Irrigation plan tuesday (binary, 1 endpoint)
Run the selected irrigation plan on tuesday.
Value can be found in the published state on the `irrigation_plan_tuesday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_tuesday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_tuesday_1": NEW_VALUE}`.
If value equals `true` irrigation plan tuesday is ON, if `false` OFF.

### Irrigation plan tuesday (binary, 2 endpoint)
Run the selected irrigation plan on tuesday.
Value can be found in the published state on the `irrigation_plan_tuesday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_tuesday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_tuesday_2": NEW_VALUE}`.
If value equals `true` irrigation plan tuesday is ON, if `false` OFF.

### Irrigation plan wednesday (binary, 1 endpoint)
Run the selected irrigation plan on wednesday.
Value can be found in the published state on the `irrigation_plan_wednesday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_wednesday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_wednesday_1": NEW_VALUE}`.
If value equals `true` irrigation plan wednesday is ON, if `false` OFF.

### Irrigation plan wednesday (binary, 2 endpoint)
Run the selected irrigation plan on wednesday.
Value can be found in the published state on the `irrigation_plan_wednesday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_wednesday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_wednesday_2": NEW_VALUE}`.
If value equals `true` irrigation plan wednesday is ON, if `false` OFF.

### Irrigation plan thursday (binary, 1 endpoint)
Run the selected irrigation plan on thursday.
Value can be found in the published state on the `irrigation_plan_thursday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_thursday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_thursday_1": NEW_VALUE}`.
If value equals `true` irrigation plan thursday is ON, if `false` OFF.

### Irrigation plan thursday (binary, 2 endpoint)
Run the selected irrigation plan on thursday.
Value can be found in the published state on the `irrigation_plan_thursday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_thursday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_thursday_2": NEW_VALUE}`.
If value equals `true` irrigation plan thursday is ON, if `false` OFF.

### Irrigation plan friday (binary, 1 endpoint)
Run the selected irrigation plan on friday.
Value can be found in the published state on the `irrigation_plan_friday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_friday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_friday_1": NEW_VALUE}`.
If value equals `true` irrigation plan friday is ON, if `false` OFF.

### Irrigation plan friday (binary, 2 endpoint)
Run the selected irrigation plan on friday.
Value can be found in the published state on the `irrigation_plan_friday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_friday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_friday_2": NEW_VALUE}`.
If value equals `true` irrigation plan friday is ON, if `false` OFF.

### Irrigation plan saturday (binary, 1 endpoint)
Run the selected irrigation plan on saturday.
Value can be found in the published state on the `irrigation_plan_saturday_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_saturday_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_saturday_1": NEW_VALUE}`.
If value equals `true` irrigation plan saturday is ON, if `false` OFF.

### Irrigation plan saturday (binary, 2 endpoint)
Run the selected irrigation plan on saturday.
Value can be found in the published state on the `irrigation_plan_saturday_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_saturday_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_saturday_2": NEW_VALUE}`.
If value equals `true` irrigation plan saturday is ON, if `false` OFF.

### Irrigation plan enable date (text, 1 endpoint)
Enable date in local YYYY-MM-DD format.
Value can be found in the published state on the `irrigation_plan_enable_date_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_enable_date_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_enable_date_1": NEW_VALUE}`.

### Irrigation plan enable date (text, 2 endpoint)
Enable date in local YYYY-MM-DD format.
Value can be found in the published state on the `irrigation_plan_enable_date_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_enable_date_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_enable_date_2": NEW_VALUE}`.

### Irrigation plan start time (text, 1 endpoint)
Start time in local HH:mm format.
Value can be found in the published state on the `irrigation_plan_start_time_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_start_time_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_start_time_1": NEW_VALUE}`.

### Irrigation plan start time (text, 2 endpoint)
Start time in local HH:mm format.
Value can be found in the published state on the `irrigation_plan_start_time_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_start_time_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_start_time_2": NEW_VALUE}`.

### Irrigation plan mode (enum, 1 endpoint)
Irrigation mode for the selected plan.
Value can be found in the published state on the `irrigation_plan_mode_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_mode_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_mode_1": NEW_VALUE}`.
The possible values are: `duration`, `capacity`, `duration_with_interval`.

### Irrigation plan mode (enum, 2 endpoint)
Irrigation mode for the selected plan.
Value can be found in the published state on the `irrigation_plan_mode_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_mode_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_mode_2": NEW_VALUE}`.
The possible values are: `duration`, `capacity`, `duration_with_interval`.

### Irrigation plan total duration (numeric, 1 endpoint)
Total duration for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_total_duration_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_total_duration_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_total_duration_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `719`.
The unit of this value is `min`.

### Irrigation plan total duration (numeric, 2 endpoint)
Total duration for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_total_duration_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_total_duration_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_total_duration_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `719`.
The unit of this value is `min`.

### Irrigation plan duration (numeric, 1 endpoint)
Irrigation duration for the selected plan.
Value can be found in the published state on the `irrigation_plan_duration_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_duration_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_duration_1": NEW_VALUE}`.
The minimal value is `1` and the maximum value is `60`.
The unit of this value is `min`.

### Irrigation plan duration (numeric, 2 endpoint)
Irrigation duration for the selected plan.
Value can be found in the published state on the `irrigation_plan_duration_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_duration_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_duration_2": NEW_VALUE}`.
The minimal value is `1` and the maximum value is `60`.
The unit of this value is `min`.

### Irrigation plan interval duration (numeric, 1 endpoint)
Pause duration between irrigation cycles.
Value can be found in the published state on the `irrigation_plan_interval_duration_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_interval_duration_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_interval_duration_1": NEW_VALUE}`.
The minimal value is `1` and the maximum value is `60`.
The unit of this value is `min`.

### Irrigation plan interval duration (numeric, 2 endpoint)
Pause duration between irrigation cycles.
Value can be found in the published state on the `irrigation_plan_interval_duration_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_interval_duration_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_interval_duration_2": NEW_VALUE}`.
The minimal value is `1` and the maximum value is `60`.
The unit of this value is `min`.

### Irrigation plan amount unit (enum, 1 endpoint)
Water amount unit for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_amount_unit_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_amount_unit_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_amount_unit_1": NEW_VALUE}`.
The possible values are: `US gallon`, `liter`.

### Irrigation plan amount unit (enum, 2 endpoint)
Water amount unit for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_amount_unit_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_amount_unit_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_amount_unit_2": NEW_VALUE}`.
The possible values are: `US gallon`, `liter`.

### Irrigation plan amount (numeric, 1 endpoint)
Water amount for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_amount_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_amount_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_amount_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `10000`.

### Irrigation plan amount (numeric, 2 endpoint)
Water amount for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_amount_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_amount_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_amount_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `10000`.

### Irrigation plan fail safe (numeric, 1 endpoint)
Safety timeout for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_fail_safe_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_fail_safe_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_fail_safe_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `719`.
The unit of this value is `min`.

### Irrigation plan fail safe (numeric, 2 endpoint)
Safety timeout for the selected irrigation plan.
Value can be found in the published state on the `irrigation_plan_fail_safe_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_fail_safe_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_fail_safe_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `719`.
The unit of this value is `min`.

### Irrigation plan create datetime (text, 1 endpoint)
Create datetime in ISO format with timezone (e.g. YYYY-MM-DDTHH:mm:ss+08:00).
Value can be found in the published state on the `irrigation_plan_create_datetime_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_create_datetime_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_create_datetime_1": NEW_VALUE}`.

### Irrigation plan create datetime (text, 2 endpoint)
Create datetime in ISO format with timezone (e.g. YYYY-MM-DDTHH:mm:ss+08:00).
Value can be found in the published state on the `irrigation_plan_create_datetime_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_plan_create_datetime_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_create_datetime_2": NEW_VALUE}`.

### Irrigation plan remove plan index (numeric, 1 endpoint)
Index of the irrigation plan to remove.
Value will **not** be published in the state.
It's not possible to read (`/get`) this value.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_remove_plan_index_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `5`.

### Irrigation plan remove plan index (numeric, 2 endpoint)
Index of the irrigation plan to remove.
Value will **not** be published in the state.
It's not possible to read (`/get`) this value.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"irrigation_plan_remove_plan_index_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `5`.

### Irrigation plan removed report (numeric, 1 endpoint)
Local irrigation plan removed report.
Value can be found in the published state on the `irrigation_plan_removed_report_1` property.
It's not possible to read (`/get`) or write (`/set`) this value.
The minimal value is `0` and the maximum value is `5`.

### Irrigation plan removed report (numeric, 2 endpoint)
Local irrigation plan removed report.
Value can be found in the published state on the `irrigation_plan_removed_report_2` property.
It's not possible to read (`/get`) or write (`/set`) this value.
The minimal value is `0` and the maximum value is `5`.

### Irrigation schedule status (composite, 1 endpoint)
Irrigation schedule execution status.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_schedule_status_1": ""}`.
...
Irrigation schedule execution status.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"irrigation_schedule_status_2": ""}`.
- `schedule_status` (enum): Schedule status allowed values: `start`, `end`, `running`, `standby`
- `schedule_index` (numeric): Schedule index 
- `schedule_type` (enum): Schedule type allowed values: `automatic`, `manual`
- `irrigation_mode` (enum): Irrigation mode allowed values: `duration`, `capacity`, `duration_with_interval`
...
Value can be found in the published state on the `real_time_irrigation_duration_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"real_time_irrigation_duration_1": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `min`.

### Real time irrigation duration (numeric, 2 endpoint)
Real-time irrigation duration.
Value can be found in the published state on the `real_time_irrigation_duration_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"real_time_irrigation_duration_2": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `min`.
...
Value can be found in the published state on the `hour_irrigation_duration_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"hour_irrigation_duration_1": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `min`.

### Hour irrigation duration (numeric, 2 endpoint)
Hourly irrigation duration.
Value can be found in the published state on the `hour_irrigation_duration_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"hour_irrigation_duration_2": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `min`.
