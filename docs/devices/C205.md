---
title: "Candeo C205 control via MQTT"
description: "Integrate your Candeo C205 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | external_switch_type, switch (state), power_on_behavior |
| Picture | ![Candeo C205](https://www.zigbee2mqtt.io/images/devices/C205.png) |
