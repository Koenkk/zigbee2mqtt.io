...
- [VINDSTYRKA air quality sensor](./E2112.md)

### Pairing

The pairing button is located underneath the front panel of the unit.

1. Remove the front panel by lifting it up from the two top clips.
2. Locate the small pairing/reset button on the control module behind the front panel.
3. Press and hold the pairing button for ~3 seconds until the LED/fan indicators start to change (fade up/down), indicating it is in pairing mode.
