---
title: "Philips 9290002617 control via MQTT"
description: "Integrate your Philips 9290002617 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2023-12-13T10:09:17Z
...
| Description | Hue white and color GU10 |
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), power_on_behavior, effect, linkquality |
| Picture | ![Philips 9290002617](https://www.zigbee2mqtt.io/images/devices/9290018195.jpg) |
...
Factory resetting a Hue bulb can be accomplished in 4 ways which are described below. After resetting the bulb will automatically connect.
...
### Hue dimmer switch
With the old generation [Hue Dimmer switches](./929002398602.md) (Model 324131137411) it is possible to put the bulbs into a factory reset. The [latest Dimmer switch](./929002398602.md) (Model 9290023986) does _NOT_ work. The light will couple with the remote, but won't activate pairing.

1. Power-supply the bulb and permit join
...
5. The bulb will be recongnized and interviewed, if not toggle lamp off and back on.
...
**Bluetooth is not supported by Model 9290002617**
