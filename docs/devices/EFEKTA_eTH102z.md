...
| Exposes | temperature, humidity, battery, voltage, battery_low, reading_interval, config_report_enable, comparison_previous_data, invert_color, enabling_temperature_control, temperature_actions, high_temperature, low_temperature, enabling_humidity_control, humidity_actions, high_humidity, low_humidity |
