...
description: "Integrate your Philips 929002376401 via Zigbee2MQTT with whatever smart home
 infrastructure you are using without the vendors bridge or gateway."
---

*To contribute to this page, edit the following
[file](https://github.com/Koenkk/zigbee2mqtt.io/blob/master/docs/devices/929002376401.md)*

# Philips 929002376401

| Model | 929002376401  |
| Vendor  | Philips  |
| Description | Hue Iris (generation 4) Limited edition |
| Exposes | light (state, brightness, color_xy, color_hs), effect, linkquality |
| Picture | ![Philips 929002376401](../images/devices/929002376401.jpg) |
