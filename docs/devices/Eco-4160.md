---
title: "Echos Eco-4160 control via MQTT"
description: "Integrate your Echos Eco-4160 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | Eco-4160  |
| Vendor  | [Echos](/supported-devices/#v=Echos)  |
...
| Picture | ![Echos Eco-4160](https://www.zigbee2mqtt.io/images/devices/Eco-4160.png) |
