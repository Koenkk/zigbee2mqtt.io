---
title: "RIBAG Licht Ribag Air O control via MQTT"
description: "Integrate your RIBAG Licht Ribag Air O via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | Ribag Air O  |
| Vendor  | [RIBAG Licht](/supported-devices/#v=RIBAG%20Licht)  |
...
| Picture | ![RIBAG Licht Ribag Air O](https://www.zigbee2mqtt.io/images/devices/Ribag-Air-O.png) |
