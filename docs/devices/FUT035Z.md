...
### Pairing
The device will enter pairing mode when turned on if it has not been paired before. Pairing mode can be forced by pushing the SET button 3 times in succession.
