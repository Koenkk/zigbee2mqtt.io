---
title: "IKEA E22xx control via MQTT"
description: "Integrate your IKEA E22xx via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, child_lock, led_enable, identify, power, voltage, current, energy |
| Picture | ![IKEA E22xx](https://www.zigbee2mqtt.io/images/devices/E22xx.png) |
...
### Led disable (binary)
Enables/disables the led on the device..
...
If value equals `TRUE` led disable is ON, if `FALSE` OFF.
