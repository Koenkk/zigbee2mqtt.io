---
title: "Lidl HG08010 control via MQTT"
description: "Integrate your Lidl HG08010 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2023-11-30T19:41:43
...
| Picture | ![Lidl HG08010](https://www.zigbee2mqtt.io/images/devices/HG08010.png) |
...
### Pairing
The pairing process described in the manual for the IAN 378599 QSG_DE (internal number of Lidl used in the manual) does not work!
I cannot confirm for the other device type recognized as Lidl HG08010 (IAN 378599 OS_DE) as I do not own that. But I think it is the same process.
...
1. Start with the light turned on.
2. Switch off the light -> wait for 10 seconds.
3. Switch on the light -> wait for 1 seconds.
4. Switch off the light -> wait for 3 seconds.
5. Switch on the light -> wait for 1 seconds.
6. Switch off the light -> wait for 3 seconds.
7. Switch on the light -> the device will be reset and pairing process starts.
