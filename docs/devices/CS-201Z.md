...
| Exposes | dry, temperature, soil_moisture, temperature_unit, temperature_calibration, soil_calibration, temperature_sampling, soil_sampling, soil_warning, battery, identify |
...
### Pairing
The sensor automatically enters pairing mode immediately after you insert the batteries. The large button with the water-drop icon is the reset key. To activate pairing mode manually, press and hold this button for 3 seconds until the red indicator light flashes.
