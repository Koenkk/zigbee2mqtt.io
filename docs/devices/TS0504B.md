---
title: "Tuya TS0504B control via MQTT"
description: "Integrate your Tuya TS0504B via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Tuya TS0504B](https://www.zigbee2mqtt.io/images/devices/TS0504B.png) |
...
1. `{"color":{"hex":"#FFFFFF"}}`
1. `{"color":{"x":0.3125, "y": 0.32894736842105265}}` this is the x/y value send by the Zigbee2MQTT frontend when you select the white color
1. `{"color":{"x":0.323, "y": 0.329}}` this is the x/y value send by Home Assistant when you select the white color (middle of the color picker wheel)
