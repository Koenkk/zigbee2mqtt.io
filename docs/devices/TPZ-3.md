---
title: "Nova Digital TPZ-3 control via MQTT"
description: "Integrate your Nova Digital TPZ-3 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Topazio smart switch 3 gangs |
| Exposes | switch (state), countdown, momentary_1, momentary_2, momentary_3, mode, backlight_mode, power_on_behavior, indicator_status, induction_mode, vibration_mode, action |
| Picture | ![Nova Digital TPZ-3](https://www.zigbee2mqtt.io/images/devices/TPZ-3.png) |
