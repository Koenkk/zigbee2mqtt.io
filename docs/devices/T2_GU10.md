---
title: "Aqara T2_GU10 control via MQTT"
description: "Integrate your Aqara T2_GU10 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_temp, color_xy), power_outage_count, device_temperature, power_on_behavior, identify, dimming_range_minimum, dimming_range_maximum, off_on_duration, on_off_duration, transition_curve_curvature, transition_initial_brightness, effect, effect_speed, effect_colors |
| Picture | ![Aqara T2_GU10](https://www.zigbee2mqtt.io/images/devices/T2_GU10.png) |
...
The possible values are: `off`, `breathing`, `candlelight`, `fading`, `flash`.
