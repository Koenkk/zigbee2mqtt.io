---
title: "Feibit FZCWD2HW-YH control via MQTT"
description: "Integrate your Feibit FZCWD2HW-YH via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | identify, light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), effect, power_on_behavior |
| Picture | ![Feibit FZCWD2HW-YH](https://www.zigbee2mqtt.io/images/devices/FZCWD2HW-YH.png) |
