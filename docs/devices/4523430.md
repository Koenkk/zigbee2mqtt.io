...
| Exposes | climate (local_temperature, occupied_heating_setpoint, system_mode, running_state, local_temperature_calibration), power, display_text, load, regulator_mode, regulator_time, sensor, floor_temp, max_floor_temp, mean_power, child_lock, frost_guard, night_switching |
...
### Power (numeric)
Calculated power usage (load * relay state).
