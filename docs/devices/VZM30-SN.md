---
title: "Inovelli VZM30-SN control via MQTT"
description: "Integrate your Inovelli VZM30-SN via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
### OutputMode (enum)
Use device as a Dimmer or an On/Off switch. Only applies when controlling bound devices..
