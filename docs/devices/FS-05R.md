---
title: "Tuya FS-05R control via MQTT"
description: "Integrate your Tuya FS-05R via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Mini dimmable switch 1 channel |
| Exposes | light (state, brightness, min_brightness), effect, do_not_disturb, power_on_behavior, switch_type |
| Picture | ![Tuya FS-05R](https://www.zigbee2mqtt.io/images/devices/FS-05R.png) |
