...
description: "Integrate your IKEA E1743 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendors bridge or gateway."
...
### Toubleshooting: Device didn't respond to OTA request
To resolve the `Device didn't respond to OTA request` error, try to push a button on it, shortly before you start the update.
