...
| Picture | ![IKEA E1743](https://psi-4ward.github.io/zigbee2mqtt.io/images/devices/E1743.jpg) |
...
### Binding
The E1743 can be bound to groups using [binding](../guide/usage/binding.md).
