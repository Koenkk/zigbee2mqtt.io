---
title: "Shaman 25EB-1/30-TYZ control via MQTT"
description: "Integrate your Shaman 25EB-1/30-TYZ via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | 25EB-1/30-TYZ  |
| Vendor  | [Shaman](/supported-devices/#v=Shaman)  |
| Description | Motorized roller shade |
| Exposes | battery, cover (state, position), reverse_direction, border, click_control, motor_fault |
| Picture | ![Shaman 25EB-1/30-TYZ](https://www.zigbee2mqtt.io/images/devices/25EB-1-30-TYZ.png) |
