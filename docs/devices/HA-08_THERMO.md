---
title: "AlecoAir HA-08_THERMO control via MQTT"
description: "Integrate your AlecoAir HA-08_THERMO via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | HA-08_THERMO  |
| Vendor  | [AlecoAir](/supported-devices/#v=AlecoAir)  |
...
| Picture | ![AlecoAir HA-08_THERMO](https://www.zigbee2mqtt.io/images/devices/HA-08_THERMO.png) |
