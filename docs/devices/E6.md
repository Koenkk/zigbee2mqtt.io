...
| Exposes | temperature, humidity, battery, battery_low, temperature_unit_convert, temperature_alarm, max_temperature, min_temperature, temperature_sensitivity, linkquality |
