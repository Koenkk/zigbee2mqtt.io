...
| Exposes | temperature, humidity, battery, battery_low, temperature_unit_convert, temperature_alarm, max_temperature, min_temperature, humidity_alarm, max_humidity, min_humidity, temperature_sensitivity, temperature_report_interval, humidity_sensitivity |
| Picture | ![Nous E6](https://www.zigbee2mqtt.io/images/devices/E6.png) |
