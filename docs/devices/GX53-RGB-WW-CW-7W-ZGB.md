---
title: "KOJIMA GX53-RGB-WW-CW-7W-ZGB control via MQTT"
description: "Integrate your KOJIMA GX53-RGB-WW-CW-7W-ZGB via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|     |     |
|-----|-----|
| Model | GX53-RGB-WW-CW-7W-ZGB  |
| Vendor  | [KOJIMA](/supported-devices/#v=KOJIMA)  |
| Description | Smart RGB LED Lamp GX53 7W |
| Exposes | light (state, brightness, color_temp, color_xy), effect, do_not_disturb, color_power_on_behavior |
| Picture | ![KOJIMA GX53-RGB-WW-CW-7W-ZGB](https://www.zigbee2mqtt.io/images/devices/GX53-RGB-WW-CW-7W-ZGB.png) |
