...
description: "Integrate your Gledopto GL-S-003Z via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_xy, color_hs), effect |
