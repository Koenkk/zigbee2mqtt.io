...
| Exposes | switch (state), power, current, voltage, energy, ac_frequency, device_temperature, linkquality |
| Picture | ![Develco SPLZB-132](https://www.zigbee2mqtt.io/images/devices/SPLZB-132.png) |
