---
title: "Manhot MH03-1Z-OLED control via MQTT"
description: "Integrate your Manhot MH03-1Z-OLED via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), countdown_1, child_lock, backlight_switch, backlight_lightness, displayoff_delay, relay_status, light_mode, on_color, off_color, sw1_name |
| Picture | ![Manhot MH03-1Z-OLED](https://www.zigbee2mqtt.io/images/devices/MH03-1Z-OLED.png) |
