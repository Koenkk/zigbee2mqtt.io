---
title: "Tuya TS0502A control via MQTT"
description: "Integrate your Tuya TS0502A via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Tuya TS0502A](https://www.zigbee2mqtt.io/images/devices/TS0502A.png) |
...
2. Turn power off for 10 seconds.
3. Turn power on for 1 second.
4. Turn power off for 3 seconds.
5. Turn power on for 1 second.
6. Turn power off for 3 seconds.
7. Turn power on.
8. controller will flash and is now reset.
