...
| Exposes | light (state, brightness, color_temp, color_hs, color_xy), effect, linkquality |
| Picture | ![OSRAM 4052899926110](https://www.zigbee2mqtt.io/images/devices/4052899926110.jpg) |
...
### Light 
This light supports the following features: `state`, `brightness`, `color_temp`, `color_hs`, `color_xy`.
