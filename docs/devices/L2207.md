---
title: "IKEA L2207 control via MQTT"
description: "Integrate your IKEA L2207 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA L2207](https://www.zigbee2mqtt.io/images/devices/L2207.png) |
...
1. Take off the cover of the light panel
2. Press the reset button on the controller using a small pin (for example a sim tool) until it starts flashing
3. The device is now in pairing mode and should be found by Zigbee2MQTT
