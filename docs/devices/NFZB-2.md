---
title: "Nova Digital NFZB-2 control via MQTT"
description: "Integrate your Nova Digital NFZB-2 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), countdown, power_outage_memory, backlight_mode, indicator_mode, inching_control_set |
| Picture | ![Nova Digital NFZB-2](https://www.zigbee2mqtt.io/images/devices/NFZB-2.png) |
