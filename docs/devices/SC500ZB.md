---
title: "LoraTap SC500ZB control via MQTT"
description: "Integrate your LoraTap SC500ZB via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | cover (state, position), moving, motor_reversal, calibration, calibration_time, indicator_mode, backlight_mode, linkquality |
