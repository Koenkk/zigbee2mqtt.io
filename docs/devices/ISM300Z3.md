...
| Exposes | switch (state), operation_mode, rf_pairing, linkquality |
| Picture | ![ShinaSystem ISM300Z3](https://www.zigbee2mqtt.io/images/devices/ISM300Z3.jpg) |
...
### Operation mode (enum)
Operation mode: "auto" - toggle by S/W, "push" - for momentary S/W, "latch" - sync S/W.
...
### Rf pairing (enum)
Enable RF pairing mode each button l1, l2, l3.
...
The possible values are: `l1`, `l2`, `l3`.
