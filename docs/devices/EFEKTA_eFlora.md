...
| Exposes | soil_moisture, battery, voltage, battery_low, temperature, humidity, illuminance, lux_factor, reading_interval, lower_level, upper_level, invert, temperature_compensation |
