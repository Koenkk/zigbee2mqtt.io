...
[file](https://github.com/Koenkk/zigbee2mqtt.io/blob/master/docs/devices/7099860PH.md)*
...
| Picture | ![Philips 7099860PH](../images/devices/7099860PH.jpg) |
...
Philips LivingColors Devices that come with
...
#### Touchlink factory reset (not tested)
See [Touchlink](../information/touchlink)

#### Hue bridge (not tested)
...
#### Hue dimmer switch (works, but you still need a LivingColors Remote to pair with zigbee2mqtt)
[VIDEO: Factory reset a Hue bulb with Hue dimmer switch](https://www.youtube.com/watch?v=qvlEAELiJKs).

#### TRADFRI remote control (not tested)
...
### Device type specific configuration (not tested)
