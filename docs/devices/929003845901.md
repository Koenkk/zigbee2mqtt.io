---
title: "Philips 929003845901 control via MQTT"
description: "Integrate your Philips 929003845901 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# Philips 929003845901

|     |     |
|-----|-----|
| Model | 929003845901  |
| Vendor  | [Philips](/supported-devices/#v=Philips)  |
| Description | Hue Tento W 29,5x29,5 cm (Black) |
| Exposes | light (state, brightness), power_on_behavior, effect, effect_speed, effect_color, identify |
| Picture | ![Philips 929003845901](https://www.zigbee2mqtt.io/images/devices/929003845901.png) |
