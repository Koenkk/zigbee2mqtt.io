...
### Binding
In order to bind this battery powered remote switch make sure: 1)You enter mode that permits new devices joining 2)You wake up this device by pressing and holding a button on it when attempting to bind it to another device inside Zigbee2MQTT portal.
