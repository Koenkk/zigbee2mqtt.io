---
title: "Coibeu ZB414 control via MQTT"
description: "Integrate your Coibeu ZB414 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | ZB414  |
| Vendor  | [Coibeu](/supported-devices/#v=Coibeu)  |
| Description | 2 gang 2 usb wall outlet 4x2 |
| Exposes | switch (state), power_on_behavior, backlight_mode, child_lock |
| Picture | ![Coibeu ZB414](https://www.zigbee2mqtt.io/images/devices/ZB414.png) |
