---
title: "BSEED EC-SL-FK86ZPCS41 control via MQTT"
description: "Integrate your BSEED EC-SL-FK86ZPCS41 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# BSEED EC-SL-FK86ZPCS41

|     |     |
|-----|-----|
| Model | EC-SL-FK86ZPCS41  |
| Vendor  | [BSEED](/supported-devices/#v=BSEED)  |
| Description | 4 gang switch with scene and backlight (Neutral line optional) |
| Exposes | switch (state), countdown, power_on_behavior, backlight_mode, indicator_mode, switch_mode, action |
| Picture | ![BSEED EC-SL-FK86ZPCS41](https://www.zigbee2mqtt.io/images/devices/EC-SL-FK86ZPCS41.png) |
