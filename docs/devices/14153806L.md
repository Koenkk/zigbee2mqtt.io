---
title: "Lidl 14153806L control via MQTT"
description: "Integrate your Lidl 14153806L via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Lidl 14153806L](https://www.zigbee2mqtt.io/images/devices/14153806L.jpg) |
...
### Pairing
To factory reset, switch 3 times power off and on. After this, the LED panel slowly blinks in paring mode.

### Color temperature
This device does not support changing the color temperature (confirmed by the [vendor](https://github.com/Koenkk/zigbee2mqtt/issues/14439#issuecomment-1363813244)). Changing the color temperature will turn on the bright white LEDs on 4000k.
