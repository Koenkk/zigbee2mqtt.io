---
title: "Melery _TZ3210_qlmnxmac control via MQTT"
description: "Integrate your Melery _TZ3210_qlmnxmac via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# Melery _TZ3210_qlmnxmac

|     |     |
|-----|-----|
| Model | _TZ3210_qlmnxmac  |
| Vendor  | [Melery](/supported-devices/#v=Melery)  |
| Description | 2 gang power point with power monitoring |
| Exposes | identify, switch (state), countdown, power_outage_memory, indicator_mode, power, current, voltage, energy, child_lock |
| Picture | ![Melery _TZ3210_qlmnxmac](https://www.zigbee2mqtt.io/images/devices/_TZ3210_qlmnxmac.png) |
