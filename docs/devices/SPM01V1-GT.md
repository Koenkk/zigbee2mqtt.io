---
title: "Tuya SPM01V1-GT control via MQTT"
description: "Integrate your Tuya SPM01V1-GT via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | voltage, power, current, power_factor, ac_frequency, energy, produced_energy, device_locating, update_frequency |
| Picture | ![Tuya SPM01V1-GT](https://www.zigbee2mqtt.io/images/devices/SPM01V1-GT.png) |
