---
title: "ONOKOM OK-AC-H-TCL-3-ZB-S-A control via MQTT"
description: "Integrate your ONOKOM OK-AC-H-TCL-3-ZB-S-A via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | ac_connected, switch (state), current_temperature, target_temperature, system_mode, mode, zb_fan_speed, vertical_vanes, horizontal_vanes, fan_speed, smart_fan_speed, vanes_swing, status_led, quiet_mode, eco_mode, turbo_mode, sleep_mode, screen_light, indoor_heat_exchanger_temperature |
| Picture | ![ONOKOM OK-AC-H-TCL-3-ZB-S-A](https://www.zigbee2mqtt.io/images/devices/OK-AC-H-TCL-3-ZB-S-A.png) |
