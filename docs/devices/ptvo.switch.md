...
The following page describes all possible topics and commands, but it may depends on your firmware configuration.
...
sensor:
  - platform: "mqtt"
    ...
    availability_topic: "zigbee2mqtt/bridge/state"
    value_template: "{{ value_json.l1 }}"
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l1"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l2"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l3"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l4"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l5"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l6"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l7"
...
sensor:
  - platform: "mqtt"
    ...
    command_topic: "zigbee2mqtt/<FRIENDLY_NAME>/get/l8"
