---
title: "Paulmann 929.63 control via MQTT"
description: "Integrate your Paulmann 929.63 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Paulmann 929.63](https://www.zigbee2mqtt.io/images/devices/929.63.png) |
...
### Pairing
To factory reste the LED (enable pairing) -> Switch the LED 5x off and on (off > 3sec / on > 2sec)
The LED will flash 10x to indicate the factory reset and is now able to pair
