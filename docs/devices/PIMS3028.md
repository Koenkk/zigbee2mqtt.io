...
| Exposes | state, cover (state, position), mode, control_back, auto_power, work_state, time_total, situation_set, fault, cover_limit, favorite_position, angle_horizontal, calibration, quick_calibration, switch, reset |
