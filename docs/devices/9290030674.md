...
Using Conbee II there are reported issues with re-pairing after a power outage.  This may be overcome by adding the device to the 'passlist' and setting permit_join for the network to true in your config file.
