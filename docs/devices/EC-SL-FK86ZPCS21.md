---
title: "BSEED EC-SL-FK86ZPCS21 control via MQTT"
description: "Integrate your BSEED EC-SL-FK86ZPCS21 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# BSEED EC-SL-FK86ZPCS21

|     |     |
|-----|-----|
| Model | EC-SL-FK86ZPCS21  |
| Vendor  | [BSEED](/supported-devices/#v=BSEED)  |
| Description | 2 gang switch with scene and backlight (no neutral line required) |
| Exposes | switch (state), countdown, power_on_behavior, backlight_mode, indicator_mode, switch_mode, action |
| Picture | ![BSEED EC-SL-FK86ZPCS21](https://www.zigbee2mqtt.io/images/devices/EC-SL-FK86ZPCS21.png) |
