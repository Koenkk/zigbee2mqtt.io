---
title: "Tuya SGS02Z control via MQTT"
description: "Integrate your Tuya SGS02Z via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Tuya SGS02Z](https://www.zigbee2mqtt.io/images/devices/SGS02Z.png) |
...
Illuminance level.
Value can be found in the published state on the `illuminance_level` property.
It's not possible to read (`/get`) or write (`/set`) this value.
The possible values are: `low-`, `low`, `nor`, `high`, `high+`.
