...
| Exposes | switch (state), flip_indicator_light, power_outage_count, device_temperature, power, energy, voltage, power_outage_memory, operation_mode, action, linkquality |
