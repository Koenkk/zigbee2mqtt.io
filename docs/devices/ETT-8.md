---
title: "EKF ETT-8 control via MQTT"
description: "Integrate your EKF ETT-8 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | ETT-8  |
| Vendor  | [EKF](/supported-devices/#v=EKF)  |
...
| Picture | ![EKF ETT-8](https://www.zigbee2mqtt.io/images/devices/ETT-8.png) |
