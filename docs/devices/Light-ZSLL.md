---
title: "Sibling Light-ZSLL control via MQTT"
description: "Integrate your Sibling Light-ZSLL via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Linear ceiling LED luminaire |
| Exposes | light (state, brightness, color_temp), effect, do_not_disturb |
| Picture | ![Sibling Light-ZSLL](https://www.zigbee2mqtt.io/images/devices/Light-ZSLL.png) |
