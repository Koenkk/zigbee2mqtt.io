---
title: "Aqara ZNQBKG40LM control via MQTT"
description: "Integrate your Aqara ZNQBKG40LM via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Aqara ZNQBKG40LM](https://www.zigbee2mqtt.io/images/devices/ZNQBKG40LM.jpg) |
...
It's not possible to read (`/get`) or write (`/set`) this value.
The possible values are: `single_top`, `double_top`, `single_bottom`, `double_bottom`, `single_both`, `double_both`.
