...
### Pairing
To initiate setup mode press and hold the setup button on the rear of the device for +- 5 seconds, until the setup light blinks red. Then press and hold the setup button again, until the light start blinking orange, it is now in pairing mode. When paired the light blinks green.
