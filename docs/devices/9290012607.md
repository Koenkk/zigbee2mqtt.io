...
### Pairing
To initiate setup mode press and hold the setup button on the rear of the device for +- 5 seconds, until the light blinks red. Then pres and hold the setup button again, until the light start blinking orange, it is now in pairing mode. When paired light blinks green.

Please note that the pairing indicator light is below the main sensor
