...
[file](https://github.com/Koenkk/zigbee2mqtt.io/blob/master/docs/devices/Meter_Reader.md)*

# Datek Eva HAN

| Model | Meter Reader  |
| Vendor  | Datek  |
| Description |AMS Meter Reader power-meter sensor |
...
| Picture | ![Datek Eva Meter Reader](../images/devices/Meter_Reader.jpg) |
...
### Should support (only tested Kamstrup)
- Aidon
- Kaifa
- Kamstrup
...
In case you are not getting any measurements, it could be that your firmware is too old. Check for OTA. Tested
and working on firmware 0.2 and 0.4.
