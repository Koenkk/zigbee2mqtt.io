...
| Picture | ![Philips 7146060PH](https://www.zigbee2mqtt.io/images/devices/7146060PH.jpg) |
...
### Pairing
Factory resetting a Hue bulb can be accomplished in 6 ways: not al methods work on all devices, some trial and error might be needed.
...
#### Button long-press
The first-generation Hue Go can be reset by long pressing the button on the bottom of the unit, [as suggested by Philips on Twitter](https://twitter.com/tweethue/status/937713840728559621).
They suggest to keep the button pressed for 35 secodns: after about 25 seconds the light wil start doing some flahes, keep pressed anyway for the whole 35.
