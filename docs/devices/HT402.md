---
title: "Stello HT402 (Stelpro Hilo) control via MQTT"
description: "Integrate your Stello HT402 (Stelpro Hilo) via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Model | HT402  |
| Vendor  | Stello  |
| Description | Hilo, line-voltage thermostat |
...
| Picture | ![Stello HT402](https://www.zigbee2mqtt.io/images/devices/HT402.jpg) |
...
Value can be found in the published state on the `16392` property.
It's not possible to read (`/get`) or write (`/set`) this value.
The unit of this value is `W`.

### Energy (numeric)
Sum of consumed energy.
Value can be found in the published state on the `16393` property.
It's not possible to read (`/get`) or write (`/set`) this value.
