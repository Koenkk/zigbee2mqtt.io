...
| Exposes | timer_seconds, led_intensity_on, led_intensity_off, minimum_brightness, led_color_on, led_color_off, light (state, brightness), effect, power_on_behavior, linkquality |
