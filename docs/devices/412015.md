...
### Force read active power
* `power` / `activePower`: Asks the device for the current active power.
...
Example of MQTT message payload to enable the power alarm at 3.3 kwh. This shouuld be sent to `zigbee2mqtt/[FRIENDLY_NAME]/set`:
