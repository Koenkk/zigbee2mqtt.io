...
| Exposes | switch (state), power, current, voltage, energy, child_lock, led_enable |
...
A. Press and hold button for +/- 1 seconds
B. When led turns blue, release, press and hold the button again
C. Led starts blinking, release after 10 blinks
D. Wait ultil led turns white
