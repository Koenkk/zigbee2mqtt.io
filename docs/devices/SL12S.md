---
title: "Momax SL12S control via MQTT"
description: "Integrate your Momax SL12S via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | SL12S  |
| Vendor  | [Momax](/supported-devices/#v=Momax)  |
...
| Picture | ![Momax SL12S](https://www.zigbee2mqtt.io/images/devices/SL12S.png) |
