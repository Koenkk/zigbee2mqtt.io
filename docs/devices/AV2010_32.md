...
## Heating or Cooling
This thermostat can work in a heating or cooling mode. You can switch between them by setting `control_sequence_of_operation` to either 'heating_only' (default after factoryu reset) or 'cooling_only'.
