...
| Exposes | switch (state), power, voltage, current, device_temperature, energy |
| Picture | ![Aurora Lighting AU-A1ZBPIA](https://www.zigbee2mqtt.io/images/devices/AU-A1ZBPIA.png) |
