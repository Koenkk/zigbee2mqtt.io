---
title: "LEDVANCE 4058075208339 control via MQTT"
description: "Integrate your LEDVANCE 4058075208339 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![LEDVANCE 4058075208339](https://www.zigbee2mqtt.io/images/devices/4058075208339.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
## Notes

### Pairing the device with a new bridge / Reset
To pair the device with a new bridge or to reset it you have to unplug and replug it 5 times with 5 seconds delay per plug. After the final step the strip begins to flash in various colours.

<img width="405" alt="image" src="https://github.com/Koenkk/zigbee2mqtt.io/assets/60095377/752bc253-b0c9-4bc2-9a23-49a550e4a401">
