---
title: "SONOFF MINI-ZBD control via MQTT"
description: "Integrate your SONOFF MINI-ZBD via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
