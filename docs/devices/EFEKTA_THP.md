---
title: "EFEKTA EFEKTA_THP control via MQTT"
description: "Integrate your EFEKTA EFEKTA_THP via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
