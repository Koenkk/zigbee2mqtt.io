---
title: "Aldi 4061458232449 control via MQTT"
description: "Integrate your Aldi 4061458232449 via Zigbee2MQTT with whatever smart home
 infrastructure you are using without the vendors bridge or gateway."
---

*To contribute to this page, edit the following
[file](https://github.com/Koenkk/zigbee2mqtt.io/blob/master/docs/devices/4061458232449.md)*

# Aldi 4061458232449

| Model | 4061458232449  |
| Vendor  | Aldi  |
| Description | LIGHTWAY Smart Home LED-Leuchtmittel - Reflektor |
| Exposes | light (state, brightness, color_temp, color_xy), effect, linkquality |
| Picture | ![Aldi 4061458232449](../images/devices/4061458232449.jpg) |
