...
| Exposes | ballast_minimum_level, ballast_maximum_level, device_mode, led_in_dark, led_if_on, identify, light (state, brightness), effect, power_on_behavior, linkquality |
| Picture | ![BTicino L4411C/N4411C/NT4411C](https://www.zigbee2mqtt.io/images/devices/L4411C-N4411C-NT4411C.png) |
