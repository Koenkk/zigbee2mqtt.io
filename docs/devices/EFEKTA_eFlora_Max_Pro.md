---
title: "EFEKTA EFEKTA_eFlora_Max_Pro control via MQTT"
description: "Integrate your EFEKTA EFEKTA_eFlora_Max_Pro via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
