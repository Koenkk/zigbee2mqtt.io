...
# Pairing 
Pair the Bitron AV2010/22 sensor to Zigbee2MQTT by holding it close to the coordinator and pressing the indicator light/button at the front for about 7 seconds. The indicator light/button will flash red once to indicate it is in pairing mode. It should now be visible in the Zigbee2MQTT Devices overview
