...
| Exposes | battery, lock (state), climate (occupied_heating_setpoint, local_temperature, pi_heating_demand), linkquality |
| Picture | ![Danfoss 014G2461](../images/devices/014G2461.jpg) |

## Notes

### Pairing
* Install the device on the valve and push the "o" button for 5 seconds to calibrate the valve motor
