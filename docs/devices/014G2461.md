...
If value equals `vertical` thermostat vertical orientation is ON, if `horizontal` OFF.
...
### Trigger time (text)
Exercise trigger time. Format: 'HH:MM' (e.g., '14:30'). Send 'undefined' to disable..
