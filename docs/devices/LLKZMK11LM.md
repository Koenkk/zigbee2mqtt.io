...
### Binding
The device allows zigbee [binding](../guide/usage/binding.html) to each individual channel. There are no output clusters however so it can't be used as a remote for other devices.
