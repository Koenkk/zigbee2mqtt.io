---
title: "EFEKTA EFEKTA_TH_v1_LR control via MQTT"
description: "Integrate your EFEKTA EFEKTA_TH_v1_LR via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | identify, temperature, humidity, battery, voltage, battery_low, reading_interval, tx_radio_power, smart_sleep, uptime, config_report_enable, comparison_previous_data, enabling_temperature_control, temperature_actions, high_temperature, low_temperature, enabling_humidity_control, humidity_actions, high_humidity, low_humidity |
| Picture | ![EFEKTA EFEKTA_TH_v1_LR](https://www.zigbee2mqtt.io/images/devices/EFEKTA_TH_v1_LR.png) |
