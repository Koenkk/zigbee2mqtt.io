---
title: "EIGHTREE EIGHTREE Socket control via MQTT"
description: "Integrate your EIGHTREE EIGHTREE Socket via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# EIGHTREE EIGHTREE Socket

|     |     |
|-----|-----|
| Model | EIGHTREE Socket  |
| Vendor  | [EIGHTREE](/supported-devices/#v=EIGHTREE)  |
...
| Picture | ![EIGHTREE EIGHTREE Socket](https://www.zigbee2mqtt.io/images/devices/EIGHTREE-Socket.png) |
