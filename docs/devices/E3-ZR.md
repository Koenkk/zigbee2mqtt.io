---
title: "MiBoxer E3-ZR control via MQTT"
description: "Integrate your MiBoxer E3-ZR via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | 3 in 1 LED Controller |
| Exposes | light (state, brightness, color_temp, color_xy), effect, do_not_disturb, color_power_on_behavior |
| Picture | ![MiBoxer E3-ZR](https://www.zigbee2mqtt.io/images/devices/E3-ZR.png) |
