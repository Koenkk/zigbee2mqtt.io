---
title: "EFEKTA zFlora_X_Max control via MQTT"
description: "Integrate your EFEKTA zFlora_X_Max via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | identify, soil_moisture, temperature, illuminance, lux_factor, reading_interval, smart_sleep, tx_radio_power, lower_level, upper_level, temperature_compensation, battery |
