...
| Exposes | switch (state), power, voltage, ac_frequency, current, energy, led_mode, led_colors, led_power_brightness, led_night_mode, buttons_enabled, wifi_status, ip_address, dhcp_enabled, wifi_config |
