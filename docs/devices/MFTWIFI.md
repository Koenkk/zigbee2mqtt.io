---
title: "Mill MFTWIFI control via MQTT"
description: "Integrate your Mill MFTWIFI via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | climate (local_temperature, occupied_heating_setpoint, system_mode) |
| Picture | ![Mill MFTWIFI](https://www.zigbee2mqtt.io/images/devices/MFTWIFI.png) |
