---
title: "Silvercrest HG06335 control via MQTT"
description: "Integrate your Silvercrest HG06335 via Zigbee2MQTT with whatever smart home
...
| Picture | ![Silvercrest HG06335](../images/devices/HG06335.jpg) |
...
It's not possible to read (`/get`) or write (`/set`) this value.
If the button on the back is pressed (i.e. the device is on the mounting plate), the value equals `true`. Otherwise it is `false`.
