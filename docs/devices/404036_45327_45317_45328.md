...
Factory resetting a bulb can be accomplished by switching it on and off five times with an interval of 1 second. After sucessful factory reset you will see a color transition.
