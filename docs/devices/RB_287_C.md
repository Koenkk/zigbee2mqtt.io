---
title: "Innr RB 287 C control via MQTT"
description: "Integrate your Innr RB 287 C via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2025-10-12T13:25:00
...
| Picture | ![Innr RB 287 C](https://www.zigbee2mqtt.io/images/devices/RB-287-C.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
Innr Smart Bulb Colour E27 1200lm 2025 model.
Manufacturer web page [here](https://innr.com/products/innr-smart-bulb-colour-e27-1200lm-2025).

## Pairing
The lights blink twice after being turned on when they are in pairing mode. The new lights should enter it automatically. The light can be reset through power cycling or touchlink.

### Power cycling

The lights can be reset after powering them on and off for 6 times, as shown in the [manufacturer's video](https://www.youtube.com/watch?v=o4D6lR5eDoo).

### Touchlink

The light can be reset via touchlink within some time after turning on. See [Touchlink](../guide/usage/touchlink.md). Alternatively, the light can be also reset with remotes that support touchlink (such as the ones from Innr, Philips Hue, Ikea and so on).
