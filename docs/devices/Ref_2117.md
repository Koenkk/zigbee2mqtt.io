---
title: "Lotus Ref 2117 control via MQTT"
description: "Integrate your Lotus Ref 2117 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | Ref 2117  |
| Vendor  | [Lotus](/supported-devices/#v=Lotus)  |
| Description | 4 gang plug + 4 USB |
| Exposes | switch (state), power_outage_memory, child_lock |
| Picture | ![Lotus Ref 2117](https://www.zigbee2mqtt.io/images/devices/Ref-2117.png) |
