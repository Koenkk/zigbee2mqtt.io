...
description: "Integrate your Develco SPLZB-131 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power, power_reactive, current, voltage, energy, ac_frequency, device_temperature, linkquality |
