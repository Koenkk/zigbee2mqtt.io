---
title: "Nous DZ control via MQTT"
description: "Integrate your Nous DZ via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | DIN Switch (with power monitoring via polling) |
| Exposes | switch (state), power, current, voltage, energy, power_outage_memory, indicator_mode |
| Picture | ![Nous DZ](https://www.zigbee2mqtt.io/images/devices/DZ.png) |
