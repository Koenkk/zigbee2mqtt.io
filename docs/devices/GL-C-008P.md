...
description: "Integrate your Gledopto GL-C-008P via Zigbee2MQTT with whatever smart home
 infrastructure you are using without the vendors bridge or gateway."
---

*To contribute to this page, edit the following
[file](https://github.com/Koenkk/zigbee2mqtt.io/blob/master/docs/devices/GL-C-008P.md)*
...
| Picture | ![Gledopto GL-C-008P](../images/devices/GL-C-008P.jpg) |
