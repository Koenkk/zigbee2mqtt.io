...
| Exposes | battery, lock (state, lock_state), pin_code, action, action_source_name, action_user, auto_relock_time, sound_volume, linkquality |
| Picture | ![Yale YRM476](https://www.zigbee2mqtt.io/images/devices/YRM476.jpg) |
