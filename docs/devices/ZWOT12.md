---
title: "AVATTO ZWOT12 control via MQTT"
description: "Integrate your AVATTO ZWOT12 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | 2 gang 2 usb wall outlet 4x2 |
| Exposes | switch (state), power_on_behavior, backlight_mode, child_lock |
| Picture | ![AVATTO ZWOT12](https://www.zigbee2mqtt.io/images/devices/ZWOT12.png) |
