---
title: "IKEA LED2403R5/LED2403R5NA control via MQTT"
description: "Integrate your IKEA LED2403R5/LED2403R5NA via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA LED2403R5/LED2403R5NA](https://www.zigbee2mqtt.io/images/devices/LED2403R5-LED2403R5NA.png) |
...
- [FCC - emissisons and teardown](https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=dmHYkA8ZM3gk7FKuFu7QEg%3D%3D&fcc_id=FHO-LED2403R5NA)

### How to pair
Turn the light on and off 12 times with 1 second intervals, on the 12th time light on keep it on and the light will turn into a blinking cool blue light and the interview/pairing process will start.
