...
description: "Integrate your BTicino L441C/N4411C/NT4411C via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendors bridge or gateway."
...
| Exposes | light (state, brightness), ballast_minimum_level, ballast_maximum_level, device_mode, permanent_led, led_when_on, linkquality |
