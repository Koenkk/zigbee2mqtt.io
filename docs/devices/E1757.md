...
### Pairing
It's recommend to first pair the included TRADFRI signal repeater in the room where you want to put the blinds. (It sn't mandatory do it, pairing works fine also without TRADFRI Signal Repeater; blinds antenna are very poor: be sure to have blinds very close to ZIgbee Coordinator o Router).
