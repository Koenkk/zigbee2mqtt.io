...
| Picture | ![IKEA E1757](https://www.zigbee2mqtt.io/images/devices/E1757.png) |
...
### Pairing
It's recommend to first pair the included TRADFRI signal repeater in the room where you want to put the blinds. (It isn't mandatory to do it, pairing works fine also without TRADFRI Signal Repeater; blinds antenna are very poor: be sure to have blinds very close to Zigbee coordinator or routers).
