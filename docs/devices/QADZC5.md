---
title: "QA QADZC5 control via MQTT"
description: "Integrate your QA QADZC5 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | 5 in 1 LED controller |
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_hs), effect, power_on_behavior, linkquality |
| Picture | ![QA QADZC5](https://www.zigbee2mqtt.io/images/devices/QADZC5.png) |
