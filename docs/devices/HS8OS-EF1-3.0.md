---
title: "Heiman HS8OS-EF1-3.0 control via MQTT"
description: "Integrate your Heiman HS8OS-EF1-3.0 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | occupancy, enable_indicator, sensitivity, ambient_light, radar_delay_time |
| Picture | ![Heiman HS8OS-EF1-3.0](https://www.zigbee2mqtt.io/images/devices/HS8OS-EF1-3.0.png) |
...
### Sensitivity (numeric)
Sensitivity of the radar sensor in range of 0 ~ 100%.
