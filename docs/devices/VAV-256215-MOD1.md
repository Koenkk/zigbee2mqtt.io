---
title: "VAV VAV-256215-MOD1 control via MQTT"
description: "Integrate your VAV VAV-256215-MOD1 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Vendor  | [VAV](/supported-devices/#v=VAV)  |
| Description | Pilot wire heating module |
| Exposes | switch (state), power_on_behavior, power, energy, pilot_wire_mode |
| Picture | ![VAV VAV-256215-MOD1](https://www.zigbee2mqtt.io/images/devices/VAV-256215-MOD1.png) |
