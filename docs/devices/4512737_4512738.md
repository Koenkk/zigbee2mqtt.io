...
## Notes
### Exposing floor sensor in Home Assistant UI
In zigbee2mqtt `configuration.yaml` add `current_temperature_template` line under your climate device:
...
Restart zigbee2mqtt for changes to take effect.

See Home Assistant documentation for current_temperature_template to understand more: https://www.home-assistant.io/integrations/climate.mqtt/#current_temperature_template 
