...
| Exposes | action, control_mode, switch_type, switch_status, load_detection_mode, load_type, load_dimmable, power_supply_mode, light (state, brightness), effect, power_on_behavior, linkquality |
