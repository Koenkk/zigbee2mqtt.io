...
| Exposes | switch (state), climate (local_temperature, local_temperature_calibration, occupied_heating_setpoint), display_flip, child_lock, frost_protection, window_detection, scale_protection, auto_calibration, calibrated |
