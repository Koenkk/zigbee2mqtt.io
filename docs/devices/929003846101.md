...
The possible values are: `blink`, `breathe`, `okay`, `channel_change`, `candle`, `sunset`, `sparkle`, `opal`, `glisten`, `underwater`, `cosmos`, `sunbeam`, `enchant`, `none`, `finish_effect`, `stop_effect`, `stop_hue_effect`.
