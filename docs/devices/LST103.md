---
title: "Gumax LST103 control via MQTT"
description: "Integrate your Gumax LST103 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2024-09-12T10:19:12.228Z
...
|-----|-----|
| Model | LST103  |
| Vendor  | [Gumax](/supported-devices/#v=Gumax)  |
...
| Picture | ![Gumax LST103](https://www.zigbee2mqtt.io/images/devices/LST103.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
## Notes
[![Gumax Lighting System](https://img.youtube.com/vi/DbxslVgVgLI/0.jpg)](https://www.youtube.com/watch?v=DbxslVgVgLI)

### Pairing
1. Power the device for at least 10 seconds.
2. Cut the power for 1 second.
3. Power on the device for 1 second.
4. Repeat step 2-3 four times in total.
5. The lighting system should flash all colours and then return to neutral white. The lighting system is now reset, and in pairing mode.

*Note:* It might help to put a routing device fairly close to the lighting system (within 2-3 meters) if pairing doesn't seem to work.

See [this video](https://www.youtube.com/watch?v=XF0IQhhXPIY) for mouting instructions, including pairing and resetting.
