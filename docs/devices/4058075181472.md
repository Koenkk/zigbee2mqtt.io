---
title: "LEDVANCE 4058075181472 control via MQTT"
description: "Integrate your LEDVANCE 4058075181472 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![LEDVANCE 4058075181472](https://www.zigbee2mqtt.io/images/devices/4058075181472.png) |
...
### Pairing
Turn the light bulb five times on and off with each phase taking 5 seconds (i.e. 5s on, 5s off ...). After turning it on the sixth time, it will cycle through its colors to indicate pairing.
