...
| Exposes | temperature, humidity, battery, voltage, battery_low, reading_interval, tx_radio_power, smart_sleep, uptime, config_report_enable, comparison_previous_data, enabling_temperature_control, switching_temperature_sensor, temperature_actions, high_temperature, low_temperature, enabling_humidity_control, switching_humidity_sensor, humidity_actions, high_humidity, low_humidity |
