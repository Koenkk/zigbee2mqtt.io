---
title: "EFEKTA EFEKTA_eTH_POW control via MQTT"
description: "Integrate your EFEKTA EFEKTA_eTH_POW via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
