---
title: "SONOFF MINI-ZB1GS control via MQTT"
description: "Integrate your SONOFF MINI-ZB1GS via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, network_indicator, turbo_mode, inching_control_set, delayed_power_on_state, delayed_power_on_time, external_trigger_mode, detach_relay_mode, device_overheated, action |
| Picture | ![SONOFF MINI-ZB1GS](https://www.zigbee2mqtt.io/images/devices/MINI-ZB1GS.png) |
