---
title: "Custom devices (DiY) EFEKTA_PWS_Max control via MQTT"
description: "Integrate your Custom devices (DiY) EFEKTA_PWS_Max via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Custom devices (DiY) EFEKTA_PWS_Max](https://www.zigbee2mqtt.io/images/devices/EFEKTA_PWS_Max.png) |
