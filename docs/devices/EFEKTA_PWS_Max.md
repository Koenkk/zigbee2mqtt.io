...
description: "Integrate your Custom devices (DiY) EFEKTA_PWS_Max via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendors bridge or gateway."
