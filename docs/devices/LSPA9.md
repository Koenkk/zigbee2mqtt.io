---
title: "Elivco LSPA9 control via MQTT"
description: "Integrate your Elivco LSPA9 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), countdown, power_outage_memory, indicator_mode, power, current, voltage, energy, child_lock, linkquality |
