...
### Pairing
**Press the pair button 4 times.** 
A red light should flash and pulsate until it connects.  
The button is found under the back cover, next to the battery.  

If that doesn't work , or if it says that the device is not supported, try pressing the on button 6 times before pressing the pair button 4 times.
...
| Long press ON <br> *(hold + release)*  | `brightness_move_up` <br> + `brightness_stop`   | *MoveWithOnOff (Up, 83)* <br> + *StopWithOnOff* |
