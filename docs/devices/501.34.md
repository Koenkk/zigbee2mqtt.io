...
## Factory Reset
Press both off switches together - do this 3x under 2 seconds to enable reset.
...
It's not possible to read (`/get`) or write (`/set`) this value.
The possible values are: `on_1`, `off_1`, `on_2`, `off_2`, `brightness_move_up_1`, `brightness_move_down_1`, `brightness_stop_1`, `brightness_move_up_2`, `brightness_move_down_2`, `brightness_stop_2`.
