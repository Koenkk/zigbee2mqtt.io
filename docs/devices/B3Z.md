---
title: "Nous B3Z control via MQTT"
description: "Integrate your Nous B3Z via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), countdown, power_on_behavior, switch_type, power, current, voltage, energy |
