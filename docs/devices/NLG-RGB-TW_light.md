...
description: "Integrate your Paul Neuhaus NLG-RGB-TW light via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
