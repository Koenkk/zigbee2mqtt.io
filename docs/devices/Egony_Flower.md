---
title: "EFEKTA Egony_Flower control via MQTT"
description: "Integrate your EFEKTA Egony_Flower via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | identify, soil_moisture, battery, voltage, battery_low, temperature, illuminance, reading_interval, smart_sleep, tx_radio_power, lifetime, resolution, temperature_offset, temperature_compensation |
