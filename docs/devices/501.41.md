...
### Pairing
You need to perform a Factory Reset, so that it can be paired. You can do this by a pressing Power + Plus Button 3 times. The pairing mode will be indicated by blinking LED
Allow joining on Zigbee2MQTT, and the controller should connect automatically
