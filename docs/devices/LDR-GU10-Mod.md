---
title: "Svetomaniya LDR-GU10-Mod control via MQTT"
description: "Integrate your Svetomaniya LDR-GU10-Mod via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_temp, color_temp_startup, level_config), effect, power_on_behavior, min_level, max_level |
| Picture | ![Svetomaniya LDR-GU10-Mod](https://www.zigbee2mqtt.io/images/devices/LDR-GU10-Mod.png) |
