---
title: "AduroSmart Extended Color WS Strip V1.0 control via MQTT"
description: "Integrate your AduroSmart Extended Color WS Strip V1.0 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# AduroSmart Extended Color WS Strip V1.0
...
| Picture | ![AduroSmart Extended Color WS Strip V1.0](https://www.zigbee2mqtt.io/images/devices/Extended-Color-WS-Strip-V1.0.png) |
