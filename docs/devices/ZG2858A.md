...
The possible values are: `on`, `off`, `brightness_step_up`, `brightness_step_down`, `brightness_move_up`, `brightness_move_down`, `brightness_stop`, `brightness_move_to_level`, `color_temperature_move`, `move_to_hue_and_saturation`, `recall`, `store`, `scene_1`, `scene_2`, `scene_3`, `scene_4`, `scene_5`, `scene_6`.
