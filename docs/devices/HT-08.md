...
| Exposes | lock (state), switch (state), climate (current_heating_setpoint, local_temperature, system_mode, running_state), linkquality |
| Picture | ![ETOP HT-08](https://www.zigbee2mqtt.io/images/devices/HT-08.jpg) |
