...
The possible values are: `blink`, `breathe`, `okay`, `channel_change`, `candle`, `fireplace`, `colorloop`, `sunrise`, `sparkle`, `opal`, `glisten`, `underwater`, `cosmos`, `sunbeam`, `enchant`, `finish_effect`, `stop_effect`, `stop_hue_effect`.
