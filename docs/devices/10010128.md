---
title: "LUUMR 10010128 control via MQTT"
description: "Integrate your LUUMR 10010128 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | 10010128  |
| Vendor  | [LUUMR](/supported-devices/#v=LUUMR)  |
| Description | Smart LED, GU10, 4,7W, RGBW, CCT, Tuya, WLAN, mat |
| Exposes | light (state, brightness, color_temp, color_xy), effect, do_not_disturb, color_power_on_behavior |
| Picture | ![LUUMR 10010128](https://www.zigbee2mqtt.io/images/devices/10010128.png) |
