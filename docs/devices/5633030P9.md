---
title: "Philips 5633030P9 control via MQTT"
description: "Integrate your Philips 5633030P9 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Hue Pillar Single Spotlight (Black) |
| Exposes | light (state, brightness, color_temp, color_temp_startup), power_on_behavior, effect, effect_speed, effect_color, identify |
| Picture | ![Philips 5633030P9](https://www.zigbee2mqtt.io/images/devices/5633030P9.png) |
