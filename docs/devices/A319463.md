---
title: "LS Deutschland GmbH A319463 control via MQTT"
description: "Integrate your LS Deutschland GmbH A319463 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | A319463  |
| Vendor  | [LS Deutschland GmbH](/supported-devices/#v=LS%20Deutschland%20GmbH)  |
| Description | Home base |
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy) |
| Picture | ![LS Deutschland GmbH A319463](https://www.zigbee2mqtt.io/images/devices/A319463.png) |
