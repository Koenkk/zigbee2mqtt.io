---
title: "Sunricher SR-ZG9041A-R control via MQTT"
description: "Integrate your Sunricher SR-ZG9041A-R via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power, voltage, current, energy, external_switch_type |
