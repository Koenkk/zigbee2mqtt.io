...
| Exposes | state, presence, distance, find_switch, illuminance_lux, move_sensitivity, presence_sensitivity, detection_distance_min, detection_distance_max, presence_timeout, linkquality |
