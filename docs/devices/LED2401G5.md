---
title: "IKEA LED2401G5 control via MQTT"
description: "Integrate your IKEA LED2401G5 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA LED2401G5](https://www.zigbee2mqtt.io/images/devices/LED2401G5.png) |
...
- [FCC - emissisons and teardown](https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=BXcbecgtzENh9jtQ4tkLUg%3D%3D&fcc_id=FHO-LED2401G5NA)
- [CSA IoT - Zigbee compliance](https://csa-iot.org/csa_product/kajplats-e27-ws-g95-clear-806lm-3/)

### Pairing
While pairing, keep the bulb close to the coordinator (adapter).

What works is to use (very) short “on’s” and a little bit longer “off’s”, where you kill the light as soon as the bulb shows signs of turning on. Start with bulb on, then off, and then 15 “on’s”, wait in the 15th ON state. (If you try play safe and go for 16 "on's" the reset sometimes fails.)
