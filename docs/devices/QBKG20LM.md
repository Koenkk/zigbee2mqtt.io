---
title: "Aqara QBKG20LM control via MQTT"
description: "Integrate your Aqara QBKG20LM via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), device_temperature, power_outage_count, power_outage_memory, operation_mode, led_disabled_night, flip_indicator_light, energy, voltage, current, power, action, linkquality |
| Picture | ![Aqara QBKG20LM](https://www.zigbee2mqtt.io/images/devices/QBKG20LM.png) |
