...
description: "Integrate your Hampton Bay 99432 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | 99432  |
| Vendor  | [Hampton Bay](/supported-devices/#v=Hampton%20Bay)  |
| Description | Universal wink enabled white ceiling fan premier remote control |
| Exposes | fan (state, mode), light (state, brightness), effect, power_on_behavior, linkquality |
| Picture | ![Hampton Bay 99432](https://www.zigbee2mqtt.io/images/devices/99432.png) |
