...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), power_on_behavior, gradient_scene, gradient, effect, effect_speed, effect_color, gradient_style, gradient_scale, gradient_offset |
...
The possible values are: `blink`, `breathe`, `okay`, `channel_change`, `candle`, `fireplace`, `colorloop`, `sunrise`, `sparkle`, `opal`, `glisten`, `prism`, `underwater`, `cosmos`, `sunbeam`, `enchant`, `sunset`, `sparkle`, `opal`, `glisten`, `underwater`, `cosmos`, `sunbeam`, `enchant`, `none`, `finish_effect`, `stop_effect`, `stop_hue_effect`.
