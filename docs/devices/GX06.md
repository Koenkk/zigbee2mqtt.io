---
title: "GIEX GX06 control via MQTT"
description: "Integrate your GIEX GX06 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2025-9-27T15:11:25
...
| Exposes | temperature, soil_moisture, temperature_unit, battery, battery_state，Illuminance state |
| Picture | ![GIEX GX06](https://www.zigbee2mqtt.io/images/devices/GX06.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
This device is functionally identical to GIEX GX04, only the appearance differs.
...
### Illuminance state (enum)
State of the ambient light.
Value can be found in the published state on the `illuminance_state` property.
It's not possible to read (`/get`) or write (`/set`) this value.
The possible values are: `low`, `medium`, `high`.
