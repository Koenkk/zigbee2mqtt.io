...
description: "Integrate your Custom devices (DiY) EFEKTA_eFlower_Pro via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendors bridge or gateway."
