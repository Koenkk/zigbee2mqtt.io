...
| White-label | Mercator Ikuü SMD4106W-RGB-ZB, Tuya A5C-21F7-01, Mercator Ikuü S9E27LED9W-RGB-Z, Aldi L122CB63H11A9.0W, Lidl 14153706L, Zemismart LXZB-ZB-09A, Feconn FE-GU10-5W, Nedis ZBLC1E14, Emos GoSmart ZQZ516R, Emos GoSmart ZQZ322R |
...
Firstly, make sure the device is powered off for more than 10 seconds before powering on the device. 
Then turn on and off three times (on-off-on-off-on) power of the device (2 to 4 seconds between each on and off). 
Wait a few moments until the lighting starts blinking rAPIDly. The device is ready for pairing
