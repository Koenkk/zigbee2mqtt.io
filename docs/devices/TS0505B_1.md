---
title: "Tuya TS0505B_1 control via MQTT"
description: "Integrate your Tuya TS0505B_1 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Tuya TS0505B_1](https://www.zigbee2mqtt.io/images/devices/TS0505B_1.png) |
| White-label | Mercator Ikuü SMD4106W-RGB-ZB, Tuya A5C-21F7-01, Mercator Ikuü S9E27LED9W-RGB-Z, Hatsy SDL-312Z, Aldi L122CB63H11A9.0W, Lidl 14153706L, Zemismart LXZB-ZB-09A, Feconn FE-GU10-5W, Nedis ZBLC1E14, Emos GoSmart ZQZ516R, Emos GoSmart ZQZ322R |
...
After powering the system the first time, the light is in pairing mode.

To reset a Tuya light: 
First, ensure that the device is powered off for more than 10 seconds before turning it back on.
Then, power cycle (switch the power on and off) the device three times (on-off-on-off-on) with a 2- to 4-second interval between each switch.
Wait a few moments until the light starts blinking rapidly. The device is now ready for pairing.
