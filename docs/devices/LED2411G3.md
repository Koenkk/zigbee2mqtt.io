---
title: "IKEA LED2411G3 control via MQTT"
description: "Integrate your IKEA LED2411G3 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA LED2411G3](https://www.zigbee2mqtt.io/images/devices/LED2411G3.png) |
...
- [FCC - emissisons and teardown](https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=FQ3jhQi24Sof72iIpyQY%2Bw%3D%3D&fcc_id=FHO-LED2411G3NA)

### Pairing
Reset into Zigbee mode and start pairing of this device by switching it off and on again 15 times. It will start flashing when pairing mode is entered.
