...
| Exposes | climate (occupied_heating_setpoint, unoccupied_heating_setpoint, local_temperature, system_mode, running_state, pi_heating_demand), thermostat_occupancy, backlight_auto_dim, keypad_lockout, energy, power, current, voltage, linkquality |
| Picture | ![Sinopé TH1124ZB](https://www.zigbee2mqtt.io/images/devices/TH1124ZB.jpg) |
...
### Climate 
This climate device supports the following features: `occupied_heating_setpoint`, `unoccupied_heating_setpoint`, `local_temperature`, `system_mode`, `running_state`, `pi_heating_demand`.
