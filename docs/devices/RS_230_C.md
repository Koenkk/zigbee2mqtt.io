---
title: "Innr RS 230 C control via MQTT"
description: "Integrate your Innr RS 230 C via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendors bridge or gateway."
...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), linkquality |
| Picture | ![Innr RS 230 C](https://psi-4ward.github.io/zigbee2mqtt.io/images/devices/RS-230-C.jpg) |
