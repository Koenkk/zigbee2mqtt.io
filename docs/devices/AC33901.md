---
title: "LEDVANCE AC33901 control via MQTT"
description: "Integrate your LEDVANCE AC33901 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2022-11-07T18:55:00
...
| Picture | ![LEDVANCE AC33901](https://www.zigbee2mqtt.io/images/devices/AC33901.png) |
...
### Power cycling
Power on the light, then turn it off and on 5 times, holding each state for 5 seconds: on, 5s off, 5s on, 5s off, 5s on, 5s off, 5s on, 5s off, 5s on, 5s off, on. 
After the final power on, the light will blink and cycle through different color temperatures to indicate it has been reset and is in pairing mode.
