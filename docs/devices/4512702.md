...
4. Immediately short press to search nearby network, indicator flashes every 1 second, 20 seconds timeout if there is no network. Indicator will then blink 5 times quickly for successful pairing.

### Factory Reset 
1. Press and hold down top two buttons (channel 1 ON and OFF) until LED indicator turns on
2. Immediately short press 5 times continuously, indicator flashes 3 times quickly to indicate successful reset.
