---
title: "Candeo C-ZB-LC20-RGB control via MQTT"
description: "Integrate your Candeo C-ZB-LC20-RGB via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_xy, color_hs, level_config), effect, power_on_behavior, identify, linkquality |
...
### Light 
This light supports the following features: `state`, `brightness`, `color_xy`, `color_hs`, `level_config`.
