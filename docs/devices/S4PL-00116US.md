---
title: "Shelly S4PL-00116US control via MQTT"
description: "Integrate your Shelly S4PL-00116US via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power, voltage, current, energy, wifi_status, ip_address, dhcp_enabled, wifi_config, identify |
| Picture | ![Shelly S4PL-00116US](https://www.zigbee2mqtt.io/images/devices/S4PL-00116US.png) |
