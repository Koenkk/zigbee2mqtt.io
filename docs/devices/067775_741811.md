...
| Exposes | switch (state), action, power, power_apparent, led_in_dark, led_if_on, power_on_behavior, linkquality |
...
### Led in dark (binary)
Enables the LED when the power socket is turned off, allowing to see it in the dark.
