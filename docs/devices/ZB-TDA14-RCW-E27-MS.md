---
title: "Moes ZB-TDA14-RCW-E27-MS control via MQTT"
description: "Integrate your Moes ZB-TDA14-RCW-E27-MS via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|     |     |
|-----|-----|
| Model | ZB-TDA14-RCW-E27-MS  |
| Vendor  | [Moes](/supported-devices/#v=Moes)  |
| Description | RGB+CCT 14W E27 LED bulb |
| Exposes | light (state, brightness, color_temp, color_xy), effect, do_not_disturb, color_power_on_behavior |
| Picture | ![Moes ZB-TDA14-RCW-E27-MS](https://www.zigbee2mqtt.io/images/devices/ZB-TDA14-RCW-E27-MS.png) |
