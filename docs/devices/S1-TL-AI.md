---
title: "Heiman S1-TL-AI control via MQTT"
description: "Integrate your Heiman S1-TL-AI via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | battery, identify, temperature, humidity, smoke, battery_low, test, muted, trigger_selftest, temporary_mute, siren_for_automation_only, secure |
| Picture | ![Heiman S1-TL-AI](https://www.zigbee2mqtt.io/images/devices/S1-TL-AI.png) |
...
### Secure (text)
Unparsed raw Zigbee message in hexadecimal.
Value can be found in the published state on the `secure` property.
It's not possible to read (`/get`) or write (`/set`) this value.
