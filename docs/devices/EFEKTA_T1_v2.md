...
| Exposes | identify, temperature, battery, voltage, battery_low, reading_interval, smart_sleep, uptime, resolution, config_report_enable, comparison_previous_data, enable_temperature, invert_logic_temperature, high_temperature, low_temperature |
