---
title: "Hilux DZ8 control via MQTT"
description: "Integrate your Hilux DZ8 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | DZ8  |
| Vendor  | [Hilux](/supported-devices/#v=Hilux)  |
| Description | Spot 7W |
| Exposes | light (state, brightness, color_temp, color_temp_startup), effect, linkquality |
| Picture | ![Hilux DZ8](https://www.zigbee2mqtt.io/images/devices/DZ8.png) |
