...
### Warning. These devices are very, very spammy (more than 15 messages per second per device). Having more than 1 in your ZigBee network is a solid no-no.
#### More information: https://github.com/Koenkk/zigbee2mqtt/discussions/21038
