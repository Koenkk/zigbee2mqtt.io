---
title: "IKEA L2208 control via MQTT"
description: "Integrate your IKEA L2208 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![IKEA L2208](https://www.zigbee2mqtt.io/images/devices/L2208.png) |
...
1. In Zigbee2MQTT enable new devices to join
2. Move the light closer to your Zigbee antenna
3. Take the lid off the light and press the reset button on the transformer
4. Within seconds the light will be discovered and paired within Zigbee2MQTT
