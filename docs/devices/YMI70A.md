---
title: "Yale YMI70A control via MQTT"
description: "Integrate your Yale YMI70A via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | battery, lock (state, lock_state), pin_code, action_source_name, action_user, auto_relock_time, sound_volume, action, linkquality |
| Picture | ![Yale YMI70A](https://www.zigbee2mqtt.io/images/devices/YMI70A.png) |
