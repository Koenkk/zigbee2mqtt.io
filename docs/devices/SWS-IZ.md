---
title: "Nobø SWS-IZ control via MQTT"
description: "Integrate your Nobø SWS-IZ via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Mode switch (Home/Sleep/Away/Vacation) |
| Exposes | operation_mode, battery, voltage, identify, action |
| Picture | ![Nobø SWS-IZ](https://www.zigbee2mqtt.io/images/devices/SWS-IZ.png) |
