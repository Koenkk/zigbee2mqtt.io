...
description: "Integrate your Keen Home SV02 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | cover (state, position), temperature, battery, pressure |
| Picture | ![Keen Home SV02](https://www.zigbee2mqtt.io/images/devices/SV02.png) |
