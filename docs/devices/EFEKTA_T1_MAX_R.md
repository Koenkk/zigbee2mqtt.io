---
title: "EFEKTA EFEKTA_T1_MAX_R control via MQTT"
description: "Integrate your EFEKTA EFEKTA_T1_MAX_R via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | identify, temperature, mains_voltage, battery, battery_low, lifetime, reading_interval, tx_radio_power, resolution, config_report_enable, comparison_previous_data, enable_temperature, invert_logic_temperature, high_temperature, low_temperature |
| Picture | ![EFEKTA EFEKTA_T1_MAX_R](https://www.zigbee2mqtt.io/images/devices/EFEKTA_T1_MAX_R.png) |
