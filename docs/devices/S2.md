...
description: "Integrate your Ubisys S2 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, power, energy, identify, action |
| Picture | ![Ubisys S2](https://www.zigbee2mqtt.io/images/devices/S2.png) |
...
### Technical Reference
For further details please take a look at the [ubisys S2 technical reference manual](https://www.ubisys.de/downloads/ubisys-s2-technical-reference.pdf)
