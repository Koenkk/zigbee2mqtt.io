---
title: "Modular MWM002 control via MQTT"
description: "Integrate your Modular MWM002 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
addedAt: 2024-04-29T19:24:39.062Z
...
|-----|-----|
| Model | MWM002  |
| Vendor  | [Modular](/supported-devices/#v=Modular)  |
| Description | 0-10V Zigbee Dimmer |
| Exposes | light (state, brightness), effect, power_on_behavior, linkquality |
| Picture | ![Modular MWM002](https://www.zigbee2mqtt.io/images/devices/MWM002.png) |
