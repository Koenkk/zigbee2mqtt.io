---
title: "Quotra B07JHL6DRV control via MQTT"
description: "Integrate your Quotra B07JHL6DRV via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy), effect |
