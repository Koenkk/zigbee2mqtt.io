---
title: "MiBoxer E2-ZR control via MQTT"
description: "Integrate your MiBoxer E2-ZR via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | 2 in 1 LED controller |
| Exposes | light (state, brightness, color_temp), effect, do_not_disturb, linkquality |
| Picture | ![MiBoxer E2-ZR](https://www.zigbee2mqtt.io/images/devices/E2-ZR.png) |
