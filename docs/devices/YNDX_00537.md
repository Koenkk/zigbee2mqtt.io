---
title: "Yandex YNDX_00537 control via MQTT"
description: "Integrate your Yandex YNDX_00537 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, power_type, switch_type, action, linkquality |
| Picture | ![Yandex YNDX_00537](https://www.zigbee2mqtt.io/images/devices/YNDX_00537.png) |
...
The possible values are: `on_`, `off_`, `toggle_`.
