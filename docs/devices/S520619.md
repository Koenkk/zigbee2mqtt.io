...
| Exposes | keypad_lockout, temperature_display_mode, climate (occupied_heating_setpoint, occupied_cooling_setpoint, local_temperature, system_mode, running_state, pi_heating_demand, pi_cooling_demand), temperature, occupancy, schneider_pilot_mode |
