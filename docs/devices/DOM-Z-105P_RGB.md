---
title: "DOMRAEM DOM-Z-105P_RGB control via MQTT"
description: "Integrate your DOMRAEM DOM-Z-105P_RGB via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_hs), effect, power_on_behavior |
| Picture | ![DOMRAEM DOM-Z-105P_RGB](https://www.zigbee2mqtt.io/images/devices/DOM-Z-105P_RGB.png) |
