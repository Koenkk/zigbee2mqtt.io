...
| Picture | ![Tuya TS0013](https://www.zigbee2mqtt.io/images/devices/TS0013.png) |
| White-label | TUYATEC GDKES-03TZXD |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
## Notes
This device does not act as a Zigbee router, even when the optional neutral connection is used.
