---
title: "Handshake Finland 2619839 control via MQTT"
description: "Integrate your Handshake Finland 2619839 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | 2619839  |
| Vendor  | [Handshake Finland](/supported-devices/#v=Handshake%20Finland)  |
| Description | 2 gang smart push dimmer |
| Exposes | light (state, brightness), effect, power_on_behavior |
| Picture | ![Handshake Finland 2619839](https://www.zigbee2mqtt.io/images/devices/2619839.png) |
