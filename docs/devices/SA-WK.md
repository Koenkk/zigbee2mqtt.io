---
title: "Nova Digital SA-WK control via MQTT"
description: "Integrate your Nova Digital SA-WK via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Description | Safira Full Switch 1 gang + socket 20A + USB-A + USB-C 4x2 |
| Exposes | switch (state), power_on_behavior, backlight_mode, child_lock |
| Picture | ![Nova Digital SA-WK](https://www.zigbee2mqtt.io/images/devices/SA-WK.png) |
