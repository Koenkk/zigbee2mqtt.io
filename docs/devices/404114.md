---
title: "MLI 404114 control via MQTT"
description: "Integrate your MLI 404114 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | 404114  |
| Vendor  | [MLI](/supported-devices/#v=MLI)  |
...
| Picture | ![MLI 404114](https://www.zigbee2mqtt.io/images/devices/404114.png) |
...
### Fix detection (invalid Zigbee model)

The device may report an invalid model identifier.  
In this case, manually edit the `modelId` in `database.db` to `tint Retro Bulb white+ambiance`.
More information in [this issue](https://github.com/Koenkk/zigbee2mqtt/issues/32393)
