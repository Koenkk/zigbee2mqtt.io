...
| Exposes | switch (state), operation_mode, power, power_outage_memory, led_disabled_night, voltage, energy, device_temperature, flip_indicator_light, action |
| Picture | ![Aqara QBKG26LM](https://www.zigbee2mqtt.io/images/devices/QBKG26LM.png) |
