...
### Pairing
Pair the device by holding the button (the water droplet is the button) for 6 seconds. The red light underneath the button will now flash a few times for about 3s.
