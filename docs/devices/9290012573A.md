...
| Model | 9290012573A  |
| Vendor  | Philips  |
| Description | Hue white and color, E27 socket, 9.5 watt power draw, 806 lumen |
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs), effect, linkquality |
| Picture | ![Philips 9290012573A](https://www.zigbee2mqtt.io/images/devices/9290012573A.jpg) |
...
The 9290012573A bulb belongs to Generation 4 of the Hue bulbs and unfortunately **does NOT** support Bluetooth.
Bluetooth in Hue bulbs is only supported from Generation 5 onwards.
