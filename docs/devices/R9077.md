---
title: "Woox R9077 control via MQTT"
description: "Integrate your Woox R9077 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Woox R9077](https://www.zigbee2mqtt.io/images/devices/R9077.jpg) |
...
### Pairing
Ensure the LED bulb is in breathing mode (the led bulb is gently flashing in a loop). If the LED bulb isn't breathing: turn ON the power for 1 second and turn OFF the power for 2seconds, repeat 3 times until the LED bulb starts to flash rapidly.
