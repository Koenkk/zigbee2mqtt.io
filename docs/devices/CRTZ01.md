---
title: "Roximo CRTZ01 control via MQTT"
description: "Integrate your Roximo CRTZ01 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | CRTZ01  |
| Vendor  | [Roximo](/supported-devices/#v=Roximo)  |
| Description | Curtain motor |
| Exposes | cover (state, position), options |
| Picture | ![Roximo CRTZ01](https://www.zigbee2mqtt.io/images/devices/CRTZ01.png) |
