---
title: "Sunricher ZG9101SAC-HP-Switch-B control via MQTT"
description: "Integrate your Sunricher ZG9101SAC-HP-Switch-B via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), external_switch_type, power, voltage, current, energy |
