...
### Firmware
Firmware version needs to be >=0.2.3. Older firmware versions are not working properly. Update via the manufacturers app (needs a Tuya compatible gateway/hub).
