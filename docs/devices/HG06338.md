...
To read the current state of this switch publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/state_l1` with payload `{""}`.
...
To read the current state of this switch publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/state_l2` with payload `{""}`.
...
To read the current state of this switch publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/state_l3` with payload `{""}`.
