...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs, level_config), power_on_behavior, color_options, gradient_scene, gradient, effect |
