---
title: "NodOn FPS-4-1-00 control via MQTT"
description: "Integrate your NodOn FPS-4-1-00 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, power, energy, temperature, humidity, pilot_wire_mode |
| Picture | ![NodOn FPS-4-1-00](https://www.zigbee2mqtt.io/images/devices/FPS-4-1-00.png) |
