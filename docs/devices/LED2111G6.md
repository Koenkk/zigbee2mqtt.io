...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs, level_config), effect, power_on_behavior, color_options, identify, linkquality |
