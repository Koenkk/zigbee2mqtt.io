---
title: "IKEA LED2111G6 control via MQTT"
description: "Integrate your IKEA LED2111G6 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_xy, color_hs, level_config), effect, power_on_behavior, color_options, identify |
...
To pair, repeat 4 times: turn on, wait ½ second, turn off, wait ½ second. Finally turn on a fifth time and leave it on. When successful, the light brightness will start pulsating.
