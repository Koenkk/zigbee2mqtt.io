---
title: "Slacky-DIY TS011F_plug-SlD control via MQTT"
description: "Integrate your Slacky-DIY TS011F_plug-SlD via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, key_lock, led_control, power, voltage, ac_frequency, current, energy, energy_reset, protect_control, automatic_restart, voltage_min, voltage_max, current_max, power_max, time_reload |
| Picture | ![Slacky-DIY TS011F_plug-SlD](https://www.zigbee2mqtt.io/images/devices/TS011F_plug-SlD.png) |


<!-- Notes BEGIN: You can edit here. Add "## Notes" headline if not already present. -->
[Original project description](https://github.com/slacky1965/tuya_plug_ts011f_zrd)
...
The possible values are: `off`, `on`, `on/off`.
