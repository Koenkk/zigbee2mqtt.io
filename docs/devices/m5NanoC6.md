---
title: "Custom devices (DiY) m5NanoC6 control via MQTT"
description: "Integrate your Custom devices (DiY) m5NanoC6 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | light (state, brightness, color_xy, color_hs), effect, power_on_behavior |
