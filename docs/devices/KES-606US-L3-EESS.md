---
title: "Zemismart KES-606US-L3-EESS control via MQTT"
description: "Integrate your Zemismart KES-606US-L3-EESS via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
# Zemismart KES-606US-L3-EESS

|     |     |
|-----|-----|
| Model | KES-606US-L3-EESS  |
| Vendor  | [Zemismart](/supported-devices/#v=Zemismart)  |
| Description | 3 gang switch with neutral |
| Exposes | switch (state), power_on_behavior, switch_mode, action |
| Picture | ![Zemismart KES-606US-L3-EESS](https://www.zigbee2mqtt.io/images/devices/KES-606US-L3-EESS.png) |
