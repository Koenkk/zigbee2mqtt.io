...
addedAt: 2026-03-07T02:04:20.689Z
...
| Exposes | battery, child_lock, climate (preset, current_heating_setpoint, local_temperature, running_state), schedule_monday, schedule_tuesday, schedule_wednesday, schedule_thursday, schedule_friday, schedule_saturday, schedule_sunday |
...
### Climate 
This climate device supports the following features: `preset`, `current_heating_setpoint`, `local_temperature`, `running_state`.
