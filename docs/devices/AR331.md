...
### Firmware
Firmware version needs to be >=1.0.4. Older firmware versions are not working properly. Update via the manufacturer's app (needs a Tuya compatible gateway/hub).
