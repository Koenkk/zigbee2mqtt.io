---
title: "LEDEPLY SG45-E26 control via MQTT"
description: "Integrate your LEDEPLY SG45-E26 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | SG45-E26  |
| Vendor  | [LEDEPLY](/supported-devices/#v=LEDEPLY)  |
| Description | Zigbee A15 5W Smart Bulbs |
| Exposes | light (state, brightness, color_temp, color_temp_startup, color_hs), effect, power_on_behavior |
| Picture | ![LEDEPLY SG45-E26](https://www.zigbee2mqtt.io/images/devices/SG45-E26.png) |
