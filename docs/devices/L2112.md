...
1. assemple the lightstrip (connect power supply/controller to the lightstrip)
2. Plug it into a power supply
3. within 5 seconds turn the device off and on again 4 times
4. the device will start blinking and shortly after that it should connect
