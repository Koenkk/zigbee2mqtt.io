...
description: "Integrate your Custom devices (DiY) DNCKATSD001 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
