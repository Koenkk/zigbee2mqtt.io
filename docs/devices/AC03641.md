...
### Pairing
To reset, start with the lighted powerd off. Power it on for 2 seconds and off for 5 seconds, five times in succession. When powering the lght on again,  it flashes shortly once to confirm.
