---
title: "Moes SR-ZS control via MQTT"
description: "Integrate your Moes SR-ZS via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, switch_mode, backlight_mode, action, linkquality |
