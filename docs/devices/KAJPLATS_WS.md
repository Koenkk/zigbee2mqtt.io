---
title: "IKEA KAJPLATS_WS control via MQTT"
description: "Integrate your IKEA KAJPLATS_WS via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
