...
| Exposes | switch (state), power_on_behavior, power, voltage, ac_frequency, power_factor, current, energy, reset_total_energy, countdown_time_on_to_off, countdown_time_off_to_on, red_led_brightness |
...
### Power factor (numeric, 1 endpoint)
Instantaneous measured power factor.
Value can be found in the published state on the `power_factor_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"power_factor_1": ""}`.
It's not possible to write (`/set`) this value.
...
### Power factor (numeric, 2 endpoint)
Instantaneous measured power factor.
Value can be found in the published state on the `power_factor_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"power_factor_2": ""}`.
It's not possible to write (`/set`) this value.
...
### Reset total energy (enum, 1 endpoint)
Reset the sum of consumed energy.
Value can be found in the published state on the `reset_total_energy_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"reset_total_energy_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"reset_total_energy_1": NEW_VALUE}`.
The possible values are: `Reset`.

### Countdown time on to off (numeric, 1 endpoint)
(ON-OFF).
Value can be found in the published state on the `countdown_time_on_to_off_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"countdown_time_on_to_off_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"countdown_time_on_to_off_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `60000`.
The unit of this value is `s`.

### Countdown time off to on (numeric, 1 endpoint)
(OFF-ON).
Value can be found in the published state on the `countdown_time_off_to_on_1` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"countdown_time_off_to_on_1": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"countdown_time_off_to_on_1": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `60000`.
The unit of this value is `s`.

### Reset total energy (enum, 2 endpoint)
Reset the sum of consumed energy.
Value can be found in the published state on the `reset_total_energy_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"reset_total_energy_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"reset_total_energy_2": NEW_VALUE}`.
The possible values are: `Reset`.

### Countdown time on to off (numeric, 2 endpoint)
(ON-OFF).
Value can be found in the published state on the `countdown_time_on_to_off_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"countdown_time_on_to_off_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"countdown_time_on_to_off_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `60000`.
The unit of this value is `s`.

### Countdown time off to on (numeric, 2 endpoint)
(OFF-ON).
Value can be found in the published state on the `countdown_time_off_to_on_2` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"countdown_time_off_to_on_2": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"countdown_time_off_to_on_2": NEW_VALUE}`.
The minimal value is `0` and the maximum value is `60000`.
The unit of this value is `s`.

### Red led brightness (numeric)
Set red led brightness.
Value can be found in the published state on the `red_led_brightness` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"red_led_brightness": ""}`.
To write (`/set`) a value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/set` with payload `{"red_led_brightness": NEW_VALUE}`.
