...
| Exposes | battery, temperature_setpoint_hold, climate (occupied_heating_setpoint, local_temperature, system_mode, running_state, fan_mode, occupied_cooling_setpoint) |
| Picture | ![Centralite 3156105](https://www.zigbee2mqtt.io/images/devices/3156105.png) |
...
* `heat_pump_mode`: Set this false if you are NOT using heat pump mode (default true). The value must be `true` or `false`
