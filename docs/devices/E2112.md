...
- [FCC](https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=EV5H8AFgrSV%2B7nCx%2Bn9epg%3D%3D&fcc_id=FHO-E2112) - emissions, teardown, manual
...
The link icon on the display will blink until it connects to the network.
...
- Pairing inside the network was tested, but not successful
  - The pair button does not do anything
  - [Binding](../guide/usage/binding.md) clusters does not appear to generate events

### Issues

- **Wrong initial data**
  - When the device boots, it may display and report wrong data (e.g. higher temperature than normal)
  - It will calibrate and report correctly after a few minutes
