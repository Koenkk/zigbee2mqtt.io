...
[fcc]: https://apps.fcc.gov/oetcf/eas/reports/ViewExhibitReport.cfm?mode=Exhibits&RequestTimeout=500&calledFromFrame=N&application_id=EV5H8AFgrSV%2B7nCx%2Bn9epg%3D%3D&fcc_id=FHO-E2112
[csa]: https://csa-iot.org/csa_product/vindstyrka-air-sensor/
[Sensirion]: https://sensirion.com/media/documents/02232963/6294E043/Info_Note_VOC_Index.pdf
[reverse]: https://github.com/just-oblivious/vindstyrka-docs
[teardown]: https://github.com/oleksiikutuzov/IKEA-VINDSTYRKA/
- [FCC][fcc] - emissisons, teardown, manual
- [CSA IoT][csa] - Zigbee compliance
- [Sensirion] - What is VOC index?
- [just-oblivious/vindstyrka-docs][reverse] - reverse engineering
- [oleksiikutuzov/IKEA-VINDSTYRKA][teardown] - teardown
...
The sensor can be bound to IKEA air purifiers (Trigger when air quality is poor)
