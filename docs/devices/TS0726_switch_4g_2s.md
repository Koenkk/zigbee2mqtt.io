---
title: "Tuya TS0726_switch_4g_2s control via MQTT"
description: "Integrate your Tuya TS0726_switch_4g_2s via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | switch (state), power_on_behavior, backlight_mode, switch_mode, action, linkquality |
