...
| Exposes | power_reactive, power_reactive_phase_b, power_reactive_phase_c, power_apparent, power_apparent_phase_b, power_apparent_phase_c, power_factor_phase_b, power_factor_phase_c, total_power, total_power_reactive, total_power_apparent, energy_phase_a, produced_energy_phase_a, energy_phase_b, produced_energy_phase_b, energy_phase_c, produced_energy_phase_c, identify, switch (state), power, voltage, ac_frequency, power_factor, current, energy, produced_energy, power_phase_b, power_phase_c, voltage_phase_b, voltage_phase_c |
...
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"energy_phase_a": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.

### Produced energy phase a (numeric)
Produced energy phase A.
Value can be found in the published state on the `produced_energy_phase_a` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"produced_energy_phase_a": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.
...
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"energy_phase_b": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.

### Produced energy phase b (numeric)
Produced energy phase B.
Value can be found in the published state on the `produced_energy_phase_b` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"produced_energy_phase_b": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.
...
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"energy_phase_c": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.

### Produced energy phase c (numeric)
Produced energy phase C.
Value can be found in the published state on the `produced_energy_phase_c` property.
To read (`/get`) the value publish a message to topic `zigbee2mqtt/FRIENDLY_NAME/get` with payload `{"produced_energy_phase_c": ""}`.
It's not possible to write (`/set`) this value.
The unit of this value is `kWh`.
