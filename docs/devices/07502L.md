...
| Exposes | occupancy, tamper, battery, illuminance, temperature, humidity, reporting_time, temperature_calibration, humidity_calibration, illuminance_calibration, pir_enable, led_enable, reporting_enable, sensitivity, keep_time, linkquality |
