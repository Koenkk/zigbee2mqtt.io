...
description: "Integrate your Innr BY 285 C via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Picture | ![Innr BY 285 C](https://www.zigbee2mqtt.io/images/devices/BY-285-C.png) |
