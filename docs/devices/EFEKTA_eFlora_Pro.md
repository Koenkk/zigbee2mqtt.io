...
| Exposes | soil_moisture, battery, voltage, battery_low, temperature, humidity, illuminance, reading_interval, invert, fastmode, lower_level, upper_level, temperature_compensation |
