...
| Exposes | ballast_minimum_level, ballast_maximum_level, device_mode, identify, led_in_dark, led_if_on, light (state, brightness), effect, power_on_behavior, linkquality |
