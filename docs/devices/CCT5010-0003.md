---
title: "Schneider Electric CCT5010-0003 control via MQTT"
description: "Integrate your Schneider Electric CCT5010-0003 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
| Exposes | ballast_minimum_level, ballast_maximum_level, dimmer_mode, light (state, brightness, level_config), effect, switch_actions |
| Picture | ![Schneider Electric CCT5010-0003](https://www.zigbee2mqtt.io/images/devices/CCT5010-0003.png) |
...
Set Switch Action for l1 Button..
...
Set Switch Action for l2 Button..
