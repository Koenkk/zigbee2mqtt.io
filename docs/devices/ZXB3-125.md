---
title: "SMTONOFF ZXB3-125 control via MQTT"
description: "Integrate your SMTONOFF ZXB3-125 via Zigbee2MQTT with whatever smart home infrastructure you are using without the vendor's bridge or gateway."
...
|-----|-----|
| Model | ZXB3-125  |
| Vendor  | [SMTONOFF](/supported-devices/#v=SMTONOFF)  |
...
| Picture | ![SMTONOFF ZXB3-125](https://www.zigbee2mqtt.io/images/devices/ZXB3-125.png) |
