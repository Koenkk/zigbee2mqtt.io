...
![The signal could be to weak fpr the message to reach its target.](../../images/router1.jpg)
...
![More transmission power on the sender side might not be sufficient for a complete message roundtrip.](../../images/router2.jpg)

Introducing a router ([read more about this](./01_zigbee_network.md)) can improve the forward path as well as the return path:

![Routers can stabilize the complete message roundtrip.](../../images/router3.jpg)
