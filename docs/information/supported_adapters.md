...
<table>
  ...
  <tr>
    ...
    <td>Initial development started on experimental (alpha stage) support for various adapters based on Silabs EFR32 SoC families with EmberZNet Serial Protocol NCP 6.7.8 firmware or later</td>
