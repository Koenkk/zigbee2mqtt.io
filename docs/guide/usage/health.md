...
```json
{
    ...
    "mqtt": {
        "connected": true, // Wether Zigbee2MQTT is connected to MQTT
        "queued": 0, // Amount of queued messages to be send to MQTT
        "published": 9, // Amount of published messages MQTT since Zigbee2MQTT started
        "received": 2 // Amount of received messages MQTT since Zigbee2MQTT started
    },
    "devices": {
        // Health info per device since Zigbee2MQTT started where the key is the device IEEE address
        "0x12345678": {
