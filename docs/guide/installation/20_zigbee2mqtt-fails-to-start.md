...
6. Your Ethernet Zigbee-Adapter is not accessible over the LAN network.
...
- If you had your Zigbee network before and such an error appears with the new Zigbee Adapter, try to switch off the Zigbee routers that were connected to your previous Zigbee network and start Zigbee2MQTT again.
