...
## Recommended
The adapters below are recommended because they use powerfull chips and are well supported by Zigbee2MQTT.
...
| ![]() |  **(experimental)** |  | [Coordinator](https://github.com/dresden-elektronik/deconz-rest-plugin/wiki/Update-deCONZ-manually) |  | [Phoscon]() |
