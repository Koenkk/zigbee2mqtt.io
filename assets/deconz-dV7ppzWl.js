...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", null, [
		...
		createBaseVNode("div", _hoisted_1, [
			_cache[7] || (_cache[7] = createBaseVNode("p", { class: "hint-container-title" }, "Warning", -1)),
		...
		_cache[16] || (_cache[16] = createStaticVNode("<h2 id=\"hardware\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#hardware\"><span>Hardware</span></a></h2><p>ConBee / ConBee II / ConBee III / RaspBee / RaspBee II</p><p>USB connected adapters (ConBee / ConBee II / ConBee III) and Raspberry Pi GPIO modules (RaspBee and RaspBee II).</p><p>Add the correct baudrate to the <code>configuration.yaml</code> into the serial section.</p><ul><li>For ConBee2: specifying the baudrate is not necessary</li><li>For Conbee and RaspBee2 it is 38400</li><li>For ConBee3 it is 115200</li></ul><p>The latest stable firmware versions are recommended and listed in the <a href=\"https://github.com/dresden-elektronik/deconz-rest-plugin/wiki/Firmware-Changelog\" target=\"_blank\" rel=\"noopener noreferrer\">firmware changelog</a>.</p><ul><li><a href=\"https://deconz.dresden-elektronik.de/deconz-firmware/\" target=\"_blank\" rel=\"noopener noreferrer\">Coordinator firmware</a></li><li><a href=\"https://phoscon.de/updater/#productselect\" target=\"_blank\" rel=\"noopener noreferrer\">Flashing tool</a> (Only Conbee 3 and FLS-M)</li><li><a href=\"https://github.com/dresden-elektronik/deconz-rest-plugin/wiki/Update-deCONZ-manually\" target=\"_blank\" rel=\"noopener noreferrer\">Flashing</a></li><li><a href=\"https://phoscon.de/conbee2#buy\" target=\"_blank\" rel=\"noopener noreferrer\">Buy</a> (ConBee II)</li><li><a href=\"https://phoscon.de/conbee3#buy\" target=\"_blank\" rel=\"noopener noreferrer\">Buy</a> (ConBee III)</li><li><a href=\"https://phoscon.de/raspbee2#buy\" target=\"_blank\" rel=\"noopener noreferrer\">Buy</a> (RaspBee II)</li></ul><img src=\"/assets/conbee-C8X3sHjA.jpg\" width=\"200\">", 8))
	]);
}
