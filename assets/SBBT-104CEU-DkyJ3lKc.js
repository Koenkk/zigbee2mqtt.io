...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", null, [
		...
		_cache[15] || (_cache[15] = createStaticVNode("<h2 id=\"firmware\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#firmware\"><span>Firmware</span></a></h2><p>It is recommended to connect Shelly devices by WiFi / Bluetooth, and update their firmware, until they gain support for OTA updates over Zigbee.</p><p>The latest firmware fixes known issues like negative power readings on some models.<br><em>Note they roll-out updates in phases. Check &quot;beta&quot; channels if you are specifically looking for a fix.</em></p><h2 id=\"notes\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#notes\"><span>Notes</span></a></h2><h3 id=\"related\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#related\"><span>Related</span></a></h3>", 5)),
		...
		_cache[16] || (_cache[16] = createStaticVNode("<h3 id=\"information\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#information\"><span>Information</span></a></h3><p>See all information on <a href=\"https://shelly-api-docs.shelly.cloud/docs-ble/Devices/BLU_ZB/button22_ZB\" target=\"_blank\" rel=\"noopener noreferrer\">Shelly API docs</a> (pairing, modes, bind actions, find&amp;bind).</p><h2 id=\"options\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#options\"><span>Options</span></a></h2>", 3)),
